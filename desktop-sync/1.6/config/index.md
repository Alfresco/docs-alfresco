...
For more info see [Sharing files]({% link desktop-sync/1.6/using/sharing.md %}).
...
By default, the Content selection screen (see [selecting content to sync]({% link desktop-sync/1.6/using/select-to-sync.md %})) 
...
See [Managing automatic installation updates]({% link desktop-sync/1.6/admin/index.md %}#manage-automatic-installation-updates) for more.
...
See [Managing automatic configuration updates]({% link desktop-sync/1.6/admin/index.md %}#manage-automatic-configuration-updates) for more.
