...
See [App icons and context menu]({% link desktop-sync/1.5/using/app-icons.md %}#application-icons-and-menu-on-windows).
...
See [application icons]({% link desktop-sync/1.5/using/app-icons.md %}#application-icons-and-menu-on-windows) for more details.
...
See [application icons]({% link desktop-sync/1.5/using/app-icons.md %}#faq/mac) for more details.
...
To avoid problems with conflicts on device registration, and content going out of sync during the migration process, you should first remove your account from the deprecated computer and then setup Desktop Sync on the new machine.
