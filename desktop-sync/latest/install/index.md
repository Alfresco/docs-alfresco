...
1. Download the setup file:
    ...
    * Windows 64-bit: `Alfresco-Desktop-Sync-Setup-v1.8.x_64.exe`
...
![Initial sync selection screen]({% link desktop-sync/images/setup-18.png %}){:height="562px" width="346px"}
...
1. Download the Mac installation file: `Alfresco-Desktop-Sync-v1.8.x.dmg`

2. Double click the downloaded file to unpack the content.

3. Double click the PKG file to start the installation: `Alfresco-Desktop-Sync-v1.8.x.pkg`
