...
5. Click **Save** to update the content.
    ...
    >    * If a file is declared as a record. See [Governance Services]({% link desktop-sync/1.13/using/ags.md %}) for more.
    >    * If your role is set to Consumer or Collaborator on files. See [Permissions]({% link desktop-sync/1.13/using/permissions.md %}) for more.
