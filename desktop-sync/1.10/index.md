...
This release of Desktop Sync is a compatibility release to support Alfresco Sync Service 3.7, and adds the **Remove Local Content** application menu option for [Windows]({% link desktop-sync/1.10/using/app-menu.md %}#menu/windows/manage-your-account) and [Mac]({% link desktop-sync/1.10/using/app-menu.md %}#menu/mac/remove-local-content).
