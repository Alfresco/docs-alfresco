...
For more information, see [Sharing files]({% link desktop-sync/1.10/using/sharing.md %}).
...
By default, the content selection dialog (see [selecting content to sync]({% link desktop-sync/1.10/using/select-to-sync.md %})) 
...
See [Managing automatic installation updates]({% link desktop-sync/1.10/admin/index.md %}#manage-automatic-installation-updates) for more.
...
See [Managing automatic configuration updates]({% link desktop-sync/1.10/admin/index.md %}#manage-automatic-configuration-updates) for more.
...
See [Manage sync configuration]({% link desktop-sync/1.10/admin/index.md %}#manage-sync-configuration) for more.
...
See [Manage enforced sync]({% link desktop-sync/1.10/admin/index.md %}#manage-enforced-sync) for more.
...
See [Manage hidden sync]({% link desktop-sync/1.10/admin/index.md %}#manage-hidden-sync) for more.
