...
1. Upgrade from Alfresco Content Services 5.x to Alfresco Content Services 6.1, for more see [Migrate Solr 4 to Solr 6]{% link search-services/latest/upgrade/migrate.md %}).
