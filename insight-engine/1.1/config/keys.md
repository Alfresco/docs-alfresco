...
4. Override the SSL properties as shown.
    ...
    See [Installing the Tomcat application server]({% link content-services/6.1/install/zip/tomcat.md %}) and [Solr configuration files]({% link insight-engine/1.1/config/index.md %}#solr-configuration-files) for more.
