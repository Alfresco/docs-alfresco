...
To implement this setup, see [Install and configure Content Services nodes]({% link content-services/6.0/admin/cluster.md %}#install-and-configure-content-services-nodes).
