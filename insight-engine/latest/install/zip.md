---
title: Installing Alfresco Search and Insight Engine
---
There are two ways of installing Search and Insight Engine with the distribution zip. Depending on your requirements you can install it with either mutual TLS or without mutual TLS.

## Installing with mutual TLS using the distribution zip
