...
| Default System Logo | *Optional.* The default system logo image. The recommended size for the logo is 28x28 px. **Note:** To set a new logo or a new background image a file must be uploaded in advance with the visibility flag set to public, for more see |
...
| Default Background Header Image | *Optional.* The default background header image.  **Note:** To set a new logo or a new background image a file must be uploaded in advance with the visibility flag set to public, for more see  |
