...
See also video explaining [creating retention schedule steps]({% link governance-services/latest/using/gs/video-tutorials.md %}#create-retention-schedule-steps).