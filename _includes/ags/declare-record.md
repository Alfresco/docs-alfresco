...
2. Hover over the file and click **More** then **Declare as Record**.
    ...
    It's still visible in its original site, identified by the ![Easy access record]({% link ags/images/ico-rm-inplace.png %}){:height="18px" width="18px"} icon, 
...
See also video explaining [declaring a file as a record]({% link ags/latest/using/gs/video-tutorials.md %}#declare-an-easy-access-record).  