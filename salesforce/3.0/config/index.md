...
Before you begin ensure you've installed the following - see the [Supported platforms]({% link salesforce/3.0/support/index.md %}) page for specific versions:

* [Alfresco Content Services]({% link content-services/latest/install/index.md %})
* [Alfresco Content Connector for Salesforce]({% link salesforce/3.0/install/index.md %})
