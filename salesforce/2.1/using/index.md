...
2. In the **Alfresco** section, enter your Alfresco login details. Contact your system administrator if you don't know what your login details are for Alfresco. See [Logging in to Alfresco]({% link content-services/6.0/using/share.md %}) for more information.
...
2. Click the **Alfresco Repository** tab.
    ...
    Log in to Alfresco. Contact your system administrator if you don't know what your login details are for Alfresco. See [Logging in to Alfresco]({% link content-services/6.0/using/share.md %}) for more information.
...
3. Enter your Alfresco login details. Contact your system administrator if you don't know what your login details are for Alfresco. See [Logging in to Alfresco]({% link content-services/6.0/using/share.md %}) for more information.
