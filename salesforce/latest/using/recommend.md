...
There is certain content, and associated metadata, that you might want only certain users to see; for example, Human Resources (HR) personnel data. Use a private site for this record type. See [Creating sites](https://docs.alfresco.com/6.2/concepts/sites-intro.html)(#LINK) for more information about the different site types.
