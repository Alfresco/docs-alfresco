...
4. Open the zip file for version 1.2 of the Identity Service and [configure its connection to the database](https://www.keycloak.org/docs/8.0/server_installation/#_database){:target="_blank"}.
