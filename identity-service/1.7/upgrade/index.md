...
Use the following information to upgrade the Identity Service to version 1.7.
...
If you are currently using the Identity Service 1.2 you must first modify the **_First Broker Login_** authentication before upgrading to version 1.7.
...
**Result:** You can now upgrade directly to version 1.7.
