...
* [Install using Helm charts]({% link identity-service/1.4/install/k8s/index.md %})
* [Install using a ZIP distribution]({% link identity-service/1.4/install/zip/index.md %})
...
Instructions are also provided for [upgrading the Identity Service]({% link identity-service/1.4/upgrade/index.md %}).
