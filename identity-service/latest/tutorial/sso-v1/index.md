---
title: Single Sign On (SSO) Guide v1
---
...
> * [Single Sign On (SSO) Guide v1]({% link identity-service/latest/tutorial/sso-v1/index.md %}) - use for versions of Content Services earlier than 7.3 (this guide)
