...
3. Deploy the Helm chart with a command similar to the following:
    ...
    The Identity Service is deployed as part of the Alfresco infrastructure chart. Normally the infrastructure chart will be deployed as part of another product chart,
