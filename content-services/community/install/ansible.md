...
This page describes how to install Alfresco Community Edition using an [Ansible](https://www.ansible.com) playbook. Ansible is an open-source software provisioning, configuration management and application installation tool enabling infrastructure as code. Alfresco provides an Ansible playbook capable of installing the latest ALfresco Community Edition.
...
To deploy Alfresco Community Edition use the following command:
