...
There are four distinct approaches to deploying Community Edition. Familiarize yourself with Alfresco's [Deployment Support Policy]({% link support/latest/policies/containerization.md %}), before selecting one of the options below.
