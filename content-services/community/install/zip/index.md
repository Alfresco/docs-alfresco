...
| alfresco-file-transfer-receiver-6.2.1.zip | File Transfer Receiver installation file. The File System Transfer Receiver transfers folders and content from an Community Edition core repository (the DM) to configured targets using the Transfer Service, for example, a remote file system.<br><br>See [Configure the File System Transfer Receiver]({% link content-services/community/admin/import-transfer.md %}#configure-file-system-transfer-receiver) for more information. |
