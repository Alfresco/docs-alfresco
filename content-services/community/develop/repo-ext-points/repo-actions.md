...
[Document Library Action]({% link content-services/community/develop/share-ext-points/doclib.md %}).
...
best practice approach to get to the Community Edition public services, such as the `NodeService`.
...
In Community Edition JavaScript the special root object `actions` are used to invoke an action.
...
Community Edition installation. Use a Repo AMP project instead.
