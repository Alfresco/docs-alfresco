...
If none of the out-of-the-box content stores suit the needs, then a custom content store can be implemented.
...
* [Using and configuring Content Stores]({% link content-services/community/admin/content-stores.md %}) - Main documentation page for out-of-the-box content stores
