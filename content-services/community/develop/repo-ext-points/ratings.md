...
Community Edition supports rating of content according to different schemes, such as likes or five-star. 
...
Community Edition provides an implementation of a Rating Service, which is intended to support application 
...
Let's start by defining the [Document Library]({% link content-services/community/develop/share-ext-points/doclib.md %}) action 
(note that this is not a repository extension but should be part of a 
[Share JAR Module]({% link content-services/community/develop/sdk.md %}#workingshare)):
...
function will take this data and call the [Repo Action]({% link content-services/community/develop/repo-ext-points/repo-actions.md %}) 
...
The [Repository Action]({% link content-services/community/develop/repo-ext-points/repo-actions.md %}) implementation look 
like this (this should be contained in a [Repository JAR Module]({% link content-services/community/develop/sdk.md %}#workingplatform)):
...
videos uploaded to Community Edition.
