...
* [ReST API]({% link content-services/community/develop/rest-api-guide/index.md %}).
...
The following diagram illustrates the platform architecture and [extension points]({% link content-services/community/develop/repo-ext-points/index.md %}).
...
* Re-implementation of individual services
