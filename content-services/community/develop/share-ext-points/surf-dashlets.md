...
[Surf Web Scripts section]({% link content-services/community/develop/share-ext-points/web-scripts.md %}). The controller of the dashlet presentation web script 
...
The controller makes use of a special root object called [remote]({% link content-services/community/develop/reference/surf-framework-ref.md %}#remoteapi), 
...
The repository web script uses a root object called `people` to search for person info. This root object is Community Edition 
