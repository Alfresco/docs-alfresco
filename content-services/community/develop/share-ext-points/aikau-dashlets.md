...
This dashlet contains the following [Aikau Widgets]({% link content-services/community/develop/share-ext-points/aikau-widgets.md %}): the dashlet itself, 
two toolbar widgets, a vertical layout widget, a logo widget, and a Hello widget. To implement it start with the 
[Surf Web Script]({% link content-services/community/develop/share-ext-points/web-scripts.md %}).
