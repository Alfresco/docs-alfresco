...
have read through the [Surf framework]({% link content-services/community/develop/software-architecture.md %}#surf-framework) 
...
If you look in the `tomcat/webapps/share/WEB-INF/classes/alfresco` directory of your Community Edition installation, 
then you’ll notice a number of files ending with `-config.xml`, such as for example `share-config.xml`. These files contain 
configuration that is loaded into a Spring bean when Community Edition starts and is accessed by Share code to 
...
[evaluators]({% link content-services/community/develop/share-ext-points/evaluators.md %}) can be used to determine when a 
...
([more info on how to enable this tool]({% link content-services/community/develop/tools.md %})#surfbug). When this 
...
[controlling rendering of components]({% link content-services/community/tutorial/share/pages.md %}#removecontent).
...
* [Surf page tutorials]({% link content-services/community/tutorial/share/pages.md %})
* [Extend an out-of-the-box Surf Widget (YUI)]({% link content-services/community/tutorial/share/doclib.md %}#customizesurfwidget)
* [Add a new menu item to "Create..." menu in DocLib]({% link content-services/community/tutorial/share/doclib.md %}#addmenuitem2createmenu)
* [Customizing the Share Header Style (Aikau)]({% link content-services/community/tutorial/share/style.md %}#customizeshareheaderstyle)
* [Adding JS packages (Aikau)]({% link content-services/community/tutorial/share/amd.md %})
