...
but instead indirectly via either a [Surf Page]({% link content-services/community/develop/share-ext-points/surf-pages.md %}) 
or a [Surf Dashlet]({% link content-services/community/develop/share-ext-points/surf-dashlets.md %}). 
Surf web scripts are also used when constructing [Aikau Pages]({% link content-services/community/develop/share-ext-points/aikau-pages.md %}) 
and [Aikau Dashlets]({% link content-services/community/develop/share-ext-points/aikau-dashlets.md %}).
...
the Internet. To do this the controller uses a special root object called [remote]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfrootobjects), which 
...
Note the use of the `http` [connector]({% link content-services/community/develop/reference/surf-framework-ref.md %}#connectorsandcreds) 
...
web script does not need any authentication with Community Edition so it could actually be called directly from 
...
It is more likely though that we would use this Web Scrip as a basis for a [Surf Dashlet]({% link content-services/community/develop/share-ext-points/surf-dashlets.md %}).
...
need to be called in context of a [Surf Page]({% link content-services/community/develop/share-ext-points/surf-pages.md %}) or a 
[Surf Dashlet]({% link content-services/community/develop/share-ext-points/surf-dashlets.md %}). Note the use of the `alfresco` 
[connector]({% link content-services/community/develop/reference/surf-framework-ref.md %}#connectorsandcreds) when communicating 
...
We should use the [v1 REST API]({% link content-services/community/develop/rest-api-guide/index.md %}) as much as possible, which requires a 
...
such as sites, then we need to use the Community Edition REST API. Both of these are accessible via the 
...
* [Surf root objects - controller]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfrootobjects) 
* [FreeMarker root objects - template]({% link content-services/community/develop/reference/freemarker-ref.md %})
...
* [Surf root objects]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfrootobjects)
...
* [Web Script tutorials]({% link content-services/community/tutorial/platform/web-scripts.md %})
