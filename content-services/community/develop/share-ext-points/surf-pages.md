...
to [Aikau pages]({% link content-services/community/develop/share-ext-points/aikau-pages.md %}). All files involved in defining a Surf page are stored under 
...
This is called the [siteData]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfobjsitedata) model and the following picture illustrates 
...
The definition of a [Surf page]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfpagexml) is done in XML and looks like this in a Hello World example:
...
The page definition refers to a [template instance]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surftemplateinstancexml) that 
...
[component]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfcomponentxml), which is defined in XML:
...
component just points to a [Surf Web Script]({% link content-services/community/develop/share-ext-points/web-scripts.md %}) that should render the HTML for 
the page region.
...
In the [widget instantiation customization tutorial]({% link content-services/community/tutorial/share/doclib.md %}#customizesurfwidget) 
...
[Web Script]({% link content-services/community/develop/share-ext-points/web-scripts.md %}) section.
...
For component web script file locations see: [Web Script]({% link content-services/community/develop/share-ext-points/web-scripts.md %}) section.

## More Information

* [Introduction to Surf Pages]({% link content-services/community/develop/software-architecture.md %}#surfpageintro) - This page contains a walk-through on how to create a Surf page, and it also has links to a page that shows how to create the same page with Aikau.
* [Spring Surf Framework Guide]({% link content-services/community/develop/reference/surf-framework-ref.md %}) - Deep dive into the Surf framework
...
* [Page tutorials]({% link content-services/community/tutorial/share/pages.md %})
