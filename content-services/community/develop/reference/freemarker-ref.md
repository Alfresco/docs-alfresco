...
|`sessionticket`|Session related information providing a single value `sessionticket.ticket` for the current authentication ticket; useful when generating some Community Edition URLs for accessing outside the web client.|
...
The [add content]({% link content-services/community/tutorial/share/pages.md %}#addcontent) and 
[removing content]({% link content-services/community/tutorial/share/pages.md %}#removecontent) tutorials relies on there being a 
