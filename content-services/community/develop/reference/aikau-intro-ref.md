...
Community Edition 201911 GA. The updated UI framework goes by the name of Aikau.
...
There have been significant enhancements to the Surf framework and deliberate refactoring of logic 
...
* Using [MD5 checksums]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surf-checksums) to allow browsers to safely cache resources indefinitely
* [Dynamically aggregating]({% link content-services/community/develop/reference/surf-framework-ref.md %}#aggregate) JavaScript and CSS dependencies into fewer resources
* [Encoding images]({% link content-services/community/develop/reference/surf-framework-ref.md %}#css) directly into CSS files.
...
[customize the client-side widgets that are instantiated]({% link content-services/community/develop/share-ext-points/surf-widgets.md %}#customizesurfwidgetinit) 
