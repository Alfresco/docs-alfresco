...
* Repository Web scripts (see this [reference]({% link content-services/community/develop/reference/repo-root-objects-ref.md %}))
* Surf Web Scripts (see this [reference]({% link content-services/community/develop/reference/surf-framework-ref.md %}#surfrootobjects))
* Rules/actions
* Workflow
* Share
...
|Root Object|Type in Script Runtime|Description|
|-----------|----------------------|-----------|
|`actions`|`org.alfresco.repo.jscript.Actions`|Root object providing invocation of registered [actions]({% link content-services/community/develop/repo-ext-points/repo-actions.md %})|
...
|`search`|`org.alfresco.repo.jscript.Search`|Root object providing access to the various Community Edition search interfaces such as FTS-Alfresco, Lucene, XPath, and Saved Search results|
