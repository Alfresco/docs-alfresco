...
Read through the [Getting started guide]({% link content-services/community/develop/index.md %}) to get up to 
...
[Platform Architecture]({% link content-services/community/develop/software-architecture.md %}#platformarch) section.
