...
It works with Content Services 5.2 or later. The tool works with Community Edition `.war` files, as long as you can 
[generate an inventory report](#run-inventory-application).

The Extension Inspector scans and validates an Alfresco [extension (AMP or JAR)]({% link content-services/community/develop/extension-packaging.md %})
