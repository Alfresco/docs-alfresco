...
## Configure Community Edition to work with a web proxy
...
See [Managing aspects]({% link content-services/community/using/content/files-folders.md %}#applyaspects) for more information.
