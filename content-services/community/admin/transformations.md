...
There are many file types (also known as MIME types) available in Community Edition and it's not always possible to transform one file type to another.
...
where `localhost:8080` is the host and port number of your active Community Edition instance.
