...
You can even set up an **RSS Feed** for the folder, see [Subscribing to an RSS feed]({% link content-services/community/using/index.md %}#subtorssfeed).
...
The **My Files** and **Shared Files** areas are locations with Share, whereas the **Repository** is an overview of everything in your Community Edition system.
...
The functionality available in the **My Files** area is identical to what you find in the Document Library, see [Working with content in a library]({% link content-services/community/using/content/manage.md %}#adding-content) for details.
...
The functionality available in the **Shared Files** area is identical to what you find in the Document Library, see [Working with content in a library]({% link content-services/community/using/content/manage.md %}#adding-content) for details.

### Repository

The **Repository** displays all the Community Edition content that you have access to, including content of all sites that you're a member of.
...
The functionality available within the Repository library is identical to what you find in a site library. See [Working with content in a library]({% link content-services/community/using/content/manage.md %}#adding-content) for details on performing specific actions within the **Repository**.
