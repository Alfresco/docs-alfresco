...
See [Plan and implement Smart Folders]({% link content-services/community/config/smart-folders/index.md %}#plan) and [Type-based, System, and Custom Smart Folders]({% link content-services/community/config/smart-folders/index.md %}#sf-type) for more information about the Smart Folders workflow and types.
...
For background information on Smart Folder Templates, see [What's a Smart Folder?]({% link content-services/community/config/smart-folders/index.md %}#sf-whatis)
...
1. Stop Alfresco Community Edition, and edit your `alfresco-global.properties` file to specify the following settings:
...
1. Upload the `addAspect_claimsFolder.js` file from `smartfolders-master/tutorials` in your Downloads directory to the **Repository > Data Dictionary > Scripts** directory in Community Edition.
