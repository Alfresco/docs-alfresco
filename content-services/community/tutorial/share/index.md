...
* **Share JAR**: [Project Structure]({% link content-services/community/develop/sdk.md %}#structureshare), [Generate Project]({% link content-services/community/develop/sdk.md %}#workingshare)
