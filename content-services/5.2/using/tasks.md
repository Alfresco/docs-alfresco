...
2.  Hover over the workflow you want to view and click **View History**.
    ...
    -   Click **View Current Tasks** at the top of the page to jump to the Current Tasks section which displays the tasks generated from the selected workflow. From here you can view ![]({% link content-services/images/ico-view-task.png %}) or edit ![]({% link content-services/images/ico-configure.png %}) a task.
