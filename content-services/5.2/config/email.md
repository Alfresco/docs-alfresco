...
-   **[Configuring inbound and outbound email](#configuring-inbound-and-outbound-email)**  
...
-   **[Configuring the Activities Feed](#configuring-the-activities-feed)**  
...
-   **[Enabling the Subscription Service](#enabling-the-subscription-service)**  
...
-   **[Configuring the email client with IMAP](#configuring-the-email-client-with-imap)**  
...
-   **[Managing inbound emails](#managing-inbound-emails)**  
...
-   **[Inbound SMTP configuration properties](#inbound-smtp-configuration-properties)**  
The Inbound SMTP email subsystem type allows you to configure the behavior of the email server and service.
-   **[Managing outbound emails](#managing-outbound-emails)**  
...
-   **[Outbound SMTP configuration properties](#outbound-smtp-configuration-properties)**  
The following properties can be configured for the Outbound SMTP subsystem type.
-   **[Handling messages by target node type](#handling-messages-by-target-node-type)**  
Default behaviors for incoming email to different types of referenced nodes.
-   **[Groups and permissions for email](#groups-and-permissions-for-email)**  
...
For information about working with Alfresco Content Services and Microsoft Outlook, see [Installing and configuring Alfresco Outlook Integration]({% link content-services/5.2/install/index.md %}#installing-and-configuring-alfresco-outlook-integration).

-   **[Enabling the IMAP protocol using alfresco-global.properties](#enabling-the-imap-protocol-using-alfresco-global.properties)**  
...
-   **[Enabling the IMAP Service using the Admin Console](#enabling-the-imap-service-using-the-admin-console)**  
...
-   **[IMAP subsystem properties](#imap-subsystem-properties)**  
The following properties can be configured for the IMAP subsystem.
-   **[IMAP mount points](#imap-mount-points)**  
...
-   **[Virtual view email format](#virtual-view-email-format)**  
...
-   **[Marking sites as IMAP favorites](#marking-sites-as-imap-favorites)**  
...
![]({% link content-services/images/imap-virtualized-view.png %})
...
1.  Select **IMAP Favorites** in the Share **My Sites** dashlet on your **My Dashboard** page:
    ...
    ![]({% link content-services/images/imap-mysites.png %})

2.  Refresh your IMAP view to see the new sites.

    ![]({% link content-services/images/imap-sites.png %})
...
## Configuring email templates using v1 REST APIs {#configuring-email-templates-using-v1-rest-apis}
...
For more information, see [Configuring customized email templates](#configuring-customized-email-templates).

-   **[Configuring customized email templates](#configuring-customized-email-templates)**  
