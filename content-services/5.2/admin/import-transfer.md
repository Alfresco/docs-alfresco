...
-   **[Using the Bulk Import tool](#using-the-bulk-import-tool)**  
...
-   **[Configuring the File System Transfer Receiver](#configuring-the-file-system-transfer-receiver)**  
...
-   **[In-place bulk import](#in-place-bulk-import)**  
...
-   **[Preparing the file system](#Preparing the file system)**  
There are a number of tasks you must do to prepare the file system before you do the bulk import.
-   **[Importing with the Bulk Import tool](#importing-with-the-bulk-import-tool)**  
...
In addition, the in-place bulk import provides support for [Managing the content store]({% link content-services/5.2/admin/content-stores.md %}#content-store-selector). This allows you to select which store the content to import is to be found.
...
Alfresco Content Services web scripts are used for bulk importing. If you choose to code the bulk import, code examples are provided to help you. In both cases, you can use the reference table to determine the fields and data that are required for a successful import.
...
For more information about log4j, see [log4j.properties file]({% link content-services/5.2/develop/extension-packaging.md %}#log4j-properties-file).

-   **[Bulk importing using the user interface](#bulk-importing-using-the-user-interface)**  
The two types of bulk import (streaming and in-place) each have a user interface, which are implemented using web scripts.
-   **[Bulk importing using a program](#bulk-importing-using-a-program)**  
Code examples show you how to complete a streaming bulk import and an in-place bulk import programmatically.
-   **[Bulk Import tool fields and values](#bulk-import-tool-fields-and-values)**  
...
![]({% link content-services/images/bulk-upload-streaming.png %})
...
![]({% link content-services/images/bulk-upload-in-place.png %})
...
For more information about the fields and their meanings, see [Bulk Import tool fields and values](#bulk-import-tool-fields-and-values).
...
For more information about the web scripts that you invoke to script a bulk import, see [Bulk importing using the user interface](#bulk-importing-using-the-user-interface).

For more information about the bulk import fields and their meanings, see [Bulk Import tool fields and values](#bulk-import-tool-fields-and-values).
...
-   **[Setting up the File System Transfer Receiver](#setting-up-the-file-system-transfer-receiver)**  
The File System Transfer Receiver is delivered as a compressed zip file.
-   **[Start File System Transfer Receiver](#start-file-system-transfer-receiver)**  
Use this information to start the File System Transfer Receiver.
-   **[File System Transfer Receiver launch properties](#file-system-transfer-receiver-launch-properties)**  
The launch properties for the File System Transfer Receiver are available in the ftr-launcher.properties file.
-   **[File System Transfer Receiver custom properties](#file-system-transfer-receiver-custom-properties)**  
The custom properties for the File System Transfer Receiver are available in the ftr-custom.properties file.
-   **[File System Transfer Receiver log file properties](#file-system-transfer-receiver-log-file-properties)**  
...
-   **[Creating a new transfer target for file system content replication](#creating-a-new-transfer-target-for-file-system-content-replication)**  
...
1.  In the source repository, create a new folder in **Company Home > Data Dictionary > Transfers > Transfer Target Groups > Default Group**.
    ...
    4.  Specify the required properties:
        ...
        2.  Specify the rest of the properties to point to the FSTR server that you've setup using [Start File System Transfer Receiver](#start-file-system-transfer-receiver).
...
3.  On the source repository, create a replication job to test the target setup.
    ...
    3.  Specify properties for Name, Payload, Transfer Target.
        ...
        Name is a new folder name; for example, Replication Job. Payload is the source content directory, and Transfer Target is the folder name that you set up in [step 1](#creating-a-new-transfer-target-for-file-system-content-replication) (Replica).
