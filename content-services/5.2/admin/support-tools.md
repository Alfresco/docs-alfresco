...
See [JMX monitoring and management extensions]({% link content-services/5.2/config/index.md %}#jmx-monitoring-and-management-extensions) for more information
...
See [Troubleshooting schema-related problems]({% link content-services/5.2/admin/troubleshoot.md %}#troubleshooting-schema-related-problems) for more information on how to manage schema-related issues.
...
You have the option to click **Run** to manually run individual scheduled jobs to ensure they're functioning correctly. See [Scheduled Jobs]({% link content-services/5.2/develop/repo-ext-points/scheduled-jobs.md %}) for more details.
