...
For information about configuring metadata extractors, see [Metadata Extractors]({% link content-services/5.2/develop/repo-ext-points/metadata-extractors.md %}).
