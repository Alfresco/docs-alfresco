...
|Use case|API|
|--------|---|
|Accessing content metadata from a Platform extension such as a web script or workflow.|[Repository JavaScript API]({% link content-services/5.2/develop/api-reference.md %}#java-api) and the [Repository JavaScript API]({% link content-services/5.2/develop/api-reference.md %}#javascript-apijava-api)|
|Accessing text content (for example txt, xml, html) for files from a Platform extension such as a web script or workflow.|[Repository JavaScript API]({% link content-services/5.2/develop/api-reference.md %}#java-api) and the [Repository JavaScript API]({% link content-services/5.2/develop/api-reference.md %}#javascript-apijava-api)|
