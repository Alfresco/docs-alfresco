...
see the [Mimetypes extension point]({% link content-services/5.2/develop/repo-ext-points/mimetypes.md %}) for more information about that.
...
[Document Transformation Engine]({% link content-services/5.2/admin/transformations.md %}#doctransformengine). It 
