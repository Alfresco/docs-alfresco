...
A `ModuleComponent` executes code and is tied to a specific [Module]({% link content-services/5.2/develop/extension-packaging.md %}). 
...
[extension point]({% link content-services/5.2/develop/repo-ext-points/bootstrap-content.md %}).
