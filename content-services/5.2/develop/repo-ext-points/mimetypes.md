...
You will typically also need to provide custom [content transformations]({% link content-services/5.2/develop/repo-ext-points/content-transformers-renditions.md %}) 
and [metadata extraction]({% link content-services/5.2/develop/repo-ext-points/metadata-extractors.md %}) to fully support the content type. To find 
...
files you would have to add a [custom transformer]({% link content-services/5.2/develop/repo-ext-points/content-transformers-renditions.md %}). 
...
* [Adding a custom MIME type]({% link content-services/5.2/config/repository.md %}#add-a-mime-type)
