...
* [Dynamically aggregating]({% link content-services/5.2/develop/reference/surf-framework-ref.md %}#aggregate) JavaScript and CSS dependencies into fewer resources
* [Encoding images]({% link content-services/5.2/develop/reference/surf-framework-ref.md %}#css) directly into CSS files.
...
[customize the client-side widgets that are instantiated]({% link content-services/5.2/develop/share-ext-points/surf-widgets.md %}#customizesurfwidgetinit)
