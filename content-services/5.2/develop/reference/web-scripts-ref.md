...
1. [Data web scripts]({% link content-services/5.2/develop/repo-ext-points/web-scripts.md %})
2. [Presentation web scripts]({% link content-services/5.2/develop/share-ext-points/web-scripts.md %})
