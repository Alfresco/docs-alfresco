---
title: Repository-tier web scripts
---
...
-   **[Understanding web scripts](#understanding-web-scripts)**  
...
-   **[Invoking web scripts](#invoking-web-scripts)**  
...
-   **[Working with client limitations](#working-with-client-limitations)**  
...
-   **[Exception handling in web scripts](#exception-handling-in-web-scripts)**  
...
-   **[Authenticating web scripts](#authenticating-web-scripts)**  
...
-   **[Forms and web scripts](#forms-and-web-scripts)**  
...
-   **[Java-backed web scripts](#java-backed-web-scripts)**  
...
![]({% link content-services/images/webscript-types.png %})

-   **[Repository web scripts](#repository-web-scripts)**  
...
-   **[Presentation web scripts](#presentation-web-scripts)**  
...
![]({% link content-services/images/wsf-design.png %})

-   **[Web script components](#web-script-components)**  
...
-   **[Format readers](#format-readers)**  
The Web Script Framework provides out-of-the-box format readers.
-   **[Response status code templates](#response-status-code-templates)**  
...
![]({% link content-services/images/9-1.png %})

-   **[Web script description document](#web-script-description-document)**  
...
-   **[Web script controller script](#web-script-controller-script)**  
A web script controller script is a JavaScript file that contains the actual logic of a web script.
-   **[Web script response template](#web-script-response-template)**  
...
A detailed reference of elements in the web script description document can be found in the [Web Script Description Language Reference]({% link content-services/5.2/develop/api-reference.md %}#web-script-description-language-reference).
...
-   **[Tunneling HTTP methods](#tunneling-http-methods)**  
...
-   **[Forcing success response status](#forcing-success-response-status)**  
...
-   **[Descriptor cache controls](#descriptor-cache-controls)**  
...
-   **[Custom client authentication](#custom-client-authentication)**  
...
-   **[Creating resource bundles supporting i18n](#creating-resource-bundles-supporting-i18n)**  
...
-   **[Adding resource bundles for additional languages](#adding-resource-bundles-for-additional-languages)**  
Once you have created and registered your web script, you can add additional resource bundles for other languages.
-   **[Overriding the default message bundle](#overriding-the-default-message-bundle)**  
...
-   **[Java approach to web scripts](#java-approach-to-web-scripts)**  
