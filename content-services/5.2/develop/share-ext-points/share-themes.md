...
* [Share theme config]({% link content-services/6.0/develop/share-ext-points/share-config.md %}#sharethemeconfig)

## Tutorials

* [Adding a custom Share Theme]({% link content-services/6.0/tutorial/share/style.md %}#addcustomtheme)
