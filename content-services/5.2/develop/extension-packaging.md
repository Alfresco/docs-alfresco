...
You can find out more about using the Admin Console in the [Admin Console documentation]({% link content-services/5.2/admin/admin-console.md %}).

-   **[Module properties file](#module-properties-file)**  
The module properties file is required by the module service to identify the module, and its details, when it is installed.
-   **[Module context file](#module-context-file)**  
...
-   **[Module package formats](#module-package-formats)**  
...
The module.properties file should be located in the directory extension_root/alfresco/module/module_name. Where extension_root is the root directory of the extension, and module_name is the name of the module.
...
-   **`module.aliases` (optional)**
    ...
    **Attention:** The `module.aliases` property can only be used in AMPs, not Simple Modules.
...
1.  [Alfresco Module Package (AMP)](#alfresco-module-package-amp)
2.  [Simple Module](#simple-module)

> **Note:** The [Alfresco SDK]({% link content-services/5.2/develop/sdk.md %}) provides a set of tools for building and deploying AMPs and Simple Modules.

Each of these Module Package formats is described in the following information.

-   **[Alfresco Module Package (AMP)](#alfresco-module-package-amp)**  
...
-   **[Advantages of AMP files](#advantages-of-amp-files)**  
The AMP file is the recommended technique for packaging your extension.
-   **[AMP file format](#amp-file-format)**  
...
-   **[AMP to WAR mapping](#amp-to-war-mapping)**  
...
-   **[Customizing the AMP to WAR mapping](#customizing-the-amp-to-war-mapping)**  
...
-   **[Using the Module Management Tool (MMT)](#using-the-module-management-tool-mmt)**  
...
The [default mappings](#amp-to-war-mapping) are applied if the file-mapping.properties file is not provided.
...
## Custom AMP to WAR location mappings {#custom-amp-to-war-location-mappings}
...
|---------|-----------|
|source/java|This contains the Java source for your Alfresco Content Services module. The package structure can be anything suitable. Many of the Alfresco Content Services written modules have the package structure `org_alfresco_module_<module_id>`, where `module_id` is the ID of the module.
...
> **Note:** If you are using the [Alfresco Content Services SDK 3]({% link content-services/5.2/develop/sdk.md %}) the correct directory structure will be created automatically for you.
...
As a minimum the Simple Module will contain a [module.properties](#module-properties-file) file, but may also contain a [module-context.xml](#module-context-file) file, if the extension has Spring beans.
