...
-   **[Introducing SurfBug](#introducing-surfbug)**  
...
-   **[Using Firebug for Browser Debugging](#using-firebug-for-browser-debugging)**  
...
SurfBug is a debugging tool built into Spring Surf that displays a variety of information about the various components on a Surf page.If you are not up to speed on Surf see [Spring Surf deep dive]({% link content-services/5.2/develop/software-architecture.md %}#surf-framework-guide).
...
![]({% link content-services/images/SurfBug-Toggle.png %})
...
![]({% link content-services/images/SurfBug-Data.png %})
...
![]({% link content-services/images/dev-extensions-share-tools-firebug-enable.png %})
...
![]({% link content-services/images/dev-extensions-share-tools-firebug-window.png %})
...
![]({% link content-services/images/dev-extensions-share-tools-firebug-folder-view.png %})
...
![]({% link content-services/images/dev-extensions-share-tools-firebug-file-upload-scripts.png %})
...
![]({% link content-services/images/dev-extensions-share-tools-firebug-file-upload-debug.png %})
