...
You have created a new Control called `Training` that has three Security Marks. The [Security Marks]({% link digital-workspace/3.1/governance/security.md %}) will be visible and useable within the Digital Workspace.
