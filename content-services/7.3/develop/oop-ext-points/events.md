...
|`data.resource.nodeType`         |String|A content model type, such as `cm:content` for a file or `cm:folder` for a folder. See [content modelling]({% link content-services/7.3/develop/repo-ext-points/content-model.md %})|
...
|`data.resource.properties`       |Object|[Content model]({% link content-services/7.3/develop/repo-ext-points/content-model.md %}) properties corresponding to the `data.resource.nodeType`.|
|`data.resource.aspectNames`      |Array|[Content model]({% link content-services/7.3/develop/repo-ext-points/content-model.md %}) aspects that have been applied to the node.|
...
Using the [Node Browser]({% link content-services/7.3/admin/troubleshoot.md %}#usingnodebrowser) the following 
...
[get metadata]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#getnodemetadata). This 
...
This code uses a custom [`ParentFolderFilter`]({% link content-services/7.3/develop/oop-sdk.md %}#parentfoldercustomfilter). 

For more information about how to extract all the properties from the message payload see [`NodeResource` info]({% link content-services/7.3/develop/oop-sdk.md %}#noderesourceobj).

To create an SDK event handler project that uses plain Java event handlers follow [these instructions]({% link content-services/7.3/develop/oop-sdk.md %}#purejavaeventhandlers).
...
To create an SDK event handler project that uses Spring Integration follow [these instructions]({% link content-services/7.3/develop/oop-sdk.md %}#springintegrationhandlers).
...
[Node Browser]({% link content-services/7.3/admin/troubleshoot.md %}#usingnodebrowser) the following 
`NodeRefs` were resolved as follows:
...
[POST nodes/{parentId}/secondary-children]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#createparentchildassoc4nodeexist)  
...
For more information about how to extract all the properties from the message payload see [`ChildAssociationResource` info]({% link content-services/7.3/develop/oop-sdk.md %}#childassocresourceobj).
...
[DELETE nodes/{parentId}/secondary-children]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#deletingassociations)  
...
[POST nodes/{sourceId}/targets]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#createparentchildassoc4nodeexist)  
...
For more information about how to extract all the properties from the message payload see [`PeerAssociationResource` info]({% link content-services/7.3/develop/oop-sdk.md %}#peerassocresourceobj).
...
[DELETE nodes/{sourceId}/targets]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#deletingassociations)  
...
permissions were set or removed for the user use the [ReST API]({% link content-services/7.3/develop/rest-api-guide/folders-files.md %}#setpermissionsnode).
