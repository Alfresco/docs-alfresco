...
The Event Gateway is a brand new Alfresco Component, introduced to improve the security of the [event mechanism]({% link content-services/7.3/develop/oop-ext-points/events.md %}). 
