...
to be in the form of a [Repository Action]({% link content-services/7.3/develop/repo-ext-points/repo-actions.md %}). Having the job implemented as a repository 
...
actions [here]({% link content-services/7.3/develop/repo-ext-points/repo-actions.md %}). We use the `ServiceRegistry` to get to the 
