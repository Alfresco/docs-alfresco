...
1. Download the Ansible playbook: `alfresco-ansible-deployment-x.x`, where `x.x` is the version number.
   ...
   You can download the Ansible playbook from the Alfresco Nexus repository available at https://nexus.alfresco.com/nexus. Log in and search for `alfresco-ansible-deployment`.
