...
There are a set of [video tutorials]({% link content-services/7.3/tutorial/video/index.md %}) related to Alfresco Share, including a [tour of the available features]({% link content-services/7.3/tutorial/video/index.md %}#tour-of-alfresco-share).
...
> **Note:** If you've [set your home page]({% link content-services/7.3/using/dashboard.md %}#sethomepage) then when you click **Home** that page will open.
