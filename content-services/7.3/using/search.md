...
If you're a [Search Manager]({% link content-services/7.3/using/permissions.md %}#searchmanager) super user then you'll have an additional **Search Manager** option you can click where you can create new search filters.
