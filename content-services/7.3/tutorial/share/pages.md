...
up on it [here]({% link content-services/7.3/develop/software-architecture.md %}#surf-framework) before starting this tutorial. 
If you have not already done so you should also review the [Introducing SurfBug]({% link content-services/7.3/develop/tools.md %}#surfbug) 
...
4.  Identify which component to add the new sub-component to.
    ...
    For this we use the [SurfBug]({% link content-services/7.3/develop/tools.md %}#surfbug) tool. Once the tool is activated (from `http://localhost:8080/share/page/surfBugStatus`) we can identify the component on the page as follows:
...
1.  Identify the web script that delivers the content that should be customized.
    ...
    For this we use the [SurfBug]({% link content-services/7.3/develop/tools.md %}#surfbug) tool. Once the tool is activated (from `http://localhost:8080/share/page/surfBugStatus`) we can identify the web script as follows:
...
1.  This tutorial assumes you have created a new [SDK All-In-One]({% link content-services/7.3/develop/sdk.md %}#workingaio) project.
