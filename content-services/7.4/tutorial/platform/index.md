...
* **Platform JAR**: [Project Structure]({% link content-services/7.4/develop/sdk.md %}#structureplatform), [Generate Project]({% link content-services/7.4/develop/sdk.md %}#workingplatform)
