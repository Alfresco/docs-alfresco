...
You can find out more about using the Repository Admin Console [here]({% link content-services/7.4/admin/admin-console.md %}).
...
#### log4j2.properties file {#log4jpropsfile}
...
A `dev-log4j2.properties` file should never be used in an ongoing during production, nor packaged as a part of any product.

##### Advanced log4j2.properties Configuration
