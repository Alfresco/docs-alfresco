...
The Extension Inspector scans and validates an Alfresco [extension (AMP or JAR)]({% link content-services/7.4/develop/extension-packaging.md %}) against an `alfresco.war` file.
