...
[Alfresco REST API]({% link content-services/7.4/develop/rest-api-guide/index.md %}).
...
Note that the special root object called [remote]({% link content-services/7.4/develop/reference/surf-framework-ref.md %}#connectorsendpoints), which is available for 
...
[ACME sample content model]({% link content-services/7.4/develop/repo-ext-points/content-model.md %}).
...
* [Admin Console Component Web Script]({% link content-services/7.4/develop/repo-ext-points/admin-console-components.md %})
* [Out-of-the-box JavaScript root objects]({% link content-services/7.4/develop/reference/repo-root-objects-ref.md %}) - for use in a JavaScript controller
* [Custom JavaScript root objects]({% link content-services/7.4/develop/repo-ext-points/javascript-root-objects.md %}) - for use in a JavaScript controller
* [Out-of-the-box FreeMarker root objects]({% link content-services/7.4/develop/reference/freemarker-ref.md %}) - for use in a template
* [Presentation Tier web scripts]({% link content-services/7.4/develop/share-ext-points/web-scripts.md %}) - i.e. Surf web scripts
* [Web Script examples that create Data Lists]({% link content-services/7.4/develop/repo-ext-points/data-lists.md %})
...
* [XML Configuration]({% link content-services/7.4/develop/reference/web-scripts-ref.md %}#wscomponents) - Additional XML configuration for Web Script
* [Cache Control]({% link content-services/7.4/develop/reference/web-scripts-ref.md %}#cachecontrols) - Additional Cache control configuration for Web Script
