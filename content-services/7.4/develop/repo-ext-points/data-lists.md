...
type. As you have probably figured out, a custom data list is defined as a type in a [content model]({% link content-services/7.4/develop/repo-ext-points/content-model.md %}).
...
association to the project members. This is just straight forward custom [content model]({% link content-services/7.4/develop/repo-ext-points/content-model.md %}) definitions.
...
[content model]({% link content-services/7.4/develop/repo-ext-points/content-model.md %}) section.
...
One way of doing this is via a [Repository Web Script]({% link content-services/7.4/develop/repo-ext-points/web-scripts.md %}). Let's create a simple 
...
* [How to use the Data Lists from a site in Alfresco Share]({% link content-services/7.4/using/sites/features.md %}#data-list)
* [Content Models]({% link content-services/7.4/develop/repo-ext-points/content-model.md %}) - data lists are a type of content model, read all about content models here
