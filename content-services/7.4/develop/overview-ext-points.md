...
The new [event system]({% link content-services/7.4/develop/oop-ext-points/events.md %}) in Content Services 7 enables 
...
You should get familiar with the [SDK 5]({% link content-services/7.4/develop/oop-sdk.md %}) as it is 
...
Also, you should get familiar with [SDK 4]({% link content-services/7.4/develop/sdk.md %}) as it is 
