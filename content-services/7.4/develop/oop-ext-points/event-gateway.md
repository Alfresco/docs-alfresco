...
The Event Gateway is a brand new Alfresco Component, introduced to improve the security of the [event mechanism]({% link content-services/7.4/develop/oop-ext-points/events.md %}). 
...
For more information on how to use the subscription API, see the [Event Gateway documentation]({% link content-services/7.4/develop/oop-sdk.md %}#using-event-gateway).
