...
The [add content]({% link content-services/7.4/tutorial/share/pages.md %}#addcontent) and 
[removing content]({% link content-services/7.4/tutorial/share/pages.md %}#removecontent) tutorials relies on there being a 
