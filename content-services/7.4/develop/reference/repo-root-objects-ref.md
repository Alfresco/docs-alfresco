...
* Repository Web scripts (see this [reference]({% link content-services/7.4/develop/reference/repo-root-objects-ref.md %}))
* Surf Web Scripts (see this [reference]({% link content-services/7.4/develop/reference/surf-framework-ref.md %}#surfrootobjects))
* Rules/actions
* Workflow
* Share
...
|Root Object|Type in Script Runtime|Description|
|-----------|----------------------|-----------|
|`actions`|`org.alfresco.repo.jscript.Actions`|Root object providing invocation of registered [actions]({% link content-services/7.4/develop/repo-ext-points/repo-actions.md %})|
