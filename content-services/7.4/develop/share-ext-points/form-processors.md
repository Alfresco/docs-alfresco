...
[Platform Architecture]({% link content-services/7.4/develop/software-architecture.md %}#platformarch)
[Share Architecture]({% link content-services/7.4/develop/software-architecture.md %}#sharearchitecture)
...
[Form Filters]({% link content-services/7.4/develop/share-ext-points/form-processor-filters.md %}). These can be used to for example alter the form data 
...
new type of field, then you should probably consider using a [Form Filter]({% link content-services/7.4/develop/share-ext-points/form-processor-filters.md %}) 
...
* [Form Processor Filters]({% link content-services/7.4/develop/share-ext-points/form-processor-filters.md %})
* [Form Controls]({% link content-services/7.4/develop/share-ext-points/form-controls.md %})
