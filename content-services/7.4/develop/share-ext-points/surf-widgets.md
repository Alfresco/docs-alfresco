...
[Surf Web Scripts section]({% link content-services/7.4/develop/share-ext-points/web-scripts.md %}). The Dashlet will contain a Button that when clicked 
...
* [Customizing Surf Widget Instantiation]({% link content-services/7.4/tutorial/share/doclib.md %}#customizesurfwidget)
