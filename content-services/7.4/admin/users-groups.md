...
> **Note:** The Content Services repository would normally be connected to a directory service to sync users and groups into the database, see [Setting up authentication and sync]({% link content-services/7.4/admin/auth-sync.md %})
...
See also Users tool [video tutorial]({% link content-services/7.4/tutorial/video/index.md %}#create-users)
...
See also Groups tool [video tutorial]({% link content-services/7.4/tutorial/video/index.md %}#create-groups).
