...
> **Note:** See the [supported platforms]({% link content-services/7.4/support/index.md %}) page for compatibility between Alfresco Content Services or Alfresco Process Services and Keycloak.
...
> **Note:** It is recommended that you familiarize yourself with the [concepts of containerized deployment]({% link content-services/7.4/install/containers/index.md %}) before working with Docker, Kubernetes, and Helm.
...
1. Download the required zip version from the [Keycloak Downloads Archive](https://www.keycloak.org/downloads-archive.html){:target="_blank"}.
   ...
   Make sure you fetch the correct Keycloak Server version from the Downloads Archive based on the compatible version listed in the [Supported platforms]({% link content-services/7.4/support/index.md %}) page.
