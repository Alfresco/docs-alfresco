...
See [Plan and implement Smart Folders]({% link content-services/7.0/config/smart-folders/index.md %}#plan) and [Type-based, System, and Custom Smart Folders]({% link content-services/7.0/config/smart-folders/index.md %}#sf-type) for more information about the Smart Folders workflow and types.
...
For background information on Smart Folder Templates, see [What's a Smart Folder?]({% link content-services/7.0/config/smart-folders/index.md %}#sf-whatis)
