...
>**Important**: For security reasons, only the following file types are allowed to view in the browser: `.pdf`, `.png`, `.jpeg`, `.gif`, `.tiff`, `.bmp`. All other file types are instead downloaded. This is [configurable]({% link content-services/7.0/config/repository.md %}#conf-view-in-browser-mime-types). 
