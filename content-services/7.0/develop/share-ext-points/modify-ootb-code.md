...
The preferred way of modifying out-of-the-box code is by using [Surf Extension Modules]({% link content-services/7.0/develop/share-ext-points/surf-extension-modules.md %}) 
...
The preferred way of modifying out-of-the-box [Surf Web Scripts]({% link content-services/7.0/develop/share-ext-points/web-scripts.md %}) 
...
The preferred way of modifying [Surf pages]({% link content-services/7.0/develop/share-ext-points/surf-pages.md %}) 
...
Currently most of these dashlets are [Surf dashlets]({% link content-services/7.0/develop/share-ext-points/surf-dashlets.md %}), 
...
The preferred way of modifying [Surf widgets]({% link content-services/7.0/develop/share-ext-points/surf-widgets.md %}) 
...
The preferred way of modifying [Aikau pages]({% link content-services/7.0/develop/share-ext-points/aikau-pages.md %}) 
...
[Aikau dashlets]({% link content-services/7.0/develop/share-ext-points/aikau-dashlets.md %}).
...
The preferred way of modifying [Aikau widgets]({% link content-services/7.0/develop/share-ext-points/aikau-widgets.md %}) 
