...
Implementing an Aikau page is greatly simplified compared to creating a [Surf page]({% link content-services/7.0/develop/share-ext-points/surf-pages.md %}). 
The only thing you need to do is implement a [Surf Web Script]({% link content-services/7.0/develop/share-ext-points/web-scripts.md %}) and zero or 
more [Aikau Widgets]({% link content-services/7.0/develop/share-ext-points/aikau-widgets.md %}).
...
* [Software Architecture - Introduction to Aikau Pages]({% link content-services/7.0/develop/software-architecture.md %}#aikauintro) - This page contains a walk-through on how to create an Aikau page, and it also has links to a page that shows how to create the same page with old-school Surf.
