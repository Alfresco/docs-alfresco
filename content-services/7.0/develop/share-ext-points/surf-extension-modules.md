...
have read through the [Surf framework]({% link content-services/7.0/develop/software-architecture.md %}#surf-framework) 
...
[evaluators]({% link content-services/7.0/develop/share-ext-points/evaluators.md %}) can be used to determine when a 
...
([more info on how to enable this tool]({% link content-services/7.0/develop/tools.md %})#surfbug). When this 
...
[controlling rendering of components]({% link content-services/7.0/tutorial/share/pages.md %}#removecontent).
...
* [Surf page tutorials]({% link content-services/7.0/tutorial/share/pages.md %})
* [Extend an out-of-the-box Surf Widget (YUI)]({% link content-services/7.0/tutorial/share/doclib.md %}#customizesurfwidget)
* [Add a new menu item to "Create..." menu in DocLib]({% link content-services/7.0/tutorial/share/doclib.md %}#addmenuitem2createmenu)
* [Customizing the Share Header Style (Aikau)]({% link content-services/7.0/tutorial/share/style.md %}#customizeshareheaderstyle)
* [Adding JS packages (Aikau)]({% link content-services/7.0/tutorial/share/amd.md %})
