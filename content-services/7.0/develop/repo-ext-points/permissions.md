...
([more info]({% link content-services/7.0/develop/repo-ext-points/content-model.md %})). We will assume we have a document library 
...
* [Some more info around defining permissions]({% link content-services/7.0/admin/security.md %}#definingpermissions)
