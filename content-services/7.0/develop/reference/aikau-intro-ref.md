...
* Using [MD5 checksums]({% link content-services/7.0/develop/reference/surf-framework-ref.md %}#surf-checksums) to allow browsers to safely cache resources indefinitely
* [Dynamically aggregating]({% link content-services/7.0/develop/reference/surf-framework-ref.md %}#aggregate) JavaScript and CSS dependencies into fewer resources
* [Encoding images]({% link content-services/7.0/develop/reference/surf-framework-ref.md %}#css) directly into CSS files.
...
[customize the client-side widgets that are instantiated]({% link content-services/7.0/develop/share-ext-points/surf-widgets.md %}#customizesurfwidgetinit)
