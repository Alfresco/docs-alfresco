...
[Alfresco Share]({% link content-services/7.0/using/share.md %}) provides a web client interface (that is a User Interface, UI) 
...
custom types, has traditionally been done with [Alfresco Modules Packages (AMP)]({% link content-services/7.0/develop/extension-packaging.md %}) 
...
Content Services provides a number of [extension points]({% link content-services/7.0/develop/overview-ext-points.md %})  
...
The repository implements and exposes these services through an [Alfresco ReST API]({% link content-services/7.0/develop/rest-api-guide/index.md %}) 
...
The following diagram illustrates the platform architecture and the [in-process extension points]({% link content-services/7.0/develop/repo-ext-points/index.md %})
and the [out-of-process extension points]({% link content-services/7.0/develop/oop-ext-points/index.md %}).
...
and APIs, such as the [ReST API]({% link content-services/7.0/develop/rest-api-guide/index.md %}).
...
[content models]({% link content-services/7.0/develop/repo-ext-points/content-model.md %}).
...
[Public Java API]({% link content-services/7.0/develop/reference/java-foundation-ref.md %}).

The platform is highly extensible. You can write extensions in Java, JavaScript, and FreeMarker, and you can write 
client applications in any language using the [ReST API]({% link content-services/7.0/develop/rest-api-guide/index.md %}). You can create new
[content models]({% link content-services/7.0/develop/repo-ext-points/content-model.md %}) that define new content types, metadata,
and relationships. You can define [custom actions]({% link content-services/7.0/develop/repo-ext-points/repo-actions.md %}) that the repository
...
For more information see [content model introduction]({% link content-services/7.0/develop/repo-ext-points/content-model.md %}).
...
* **[Alfresco Share]({% link content-services/7.0/using/share.md %})** - the traditional web client that are still heavily used, but it is based on some technology that might not be well known among developers.
...
*[Extension Points]({% link content-services/7.0/develop/share-ext-points/index.md %})*, which are supported ways of injecting new
...
([Surf deep dive]({% link content-services/7.0/develop/reference/surf-framework-ref.md %})). This means that the
...
([Surf Reference]({% link content-services/7.0/develop/reference/surf-framework-ref.md %})). You will however mostly be dealing with component,
...
The full tutorial, and introduction to Surf Pages, can be found ([here]({% link content-services/7.0/develop/share-ext-points/surf-pages.md %})).
...
For a full tutorial and introduction to Aikau Pages, see ([Introduction to Aikau Pages]({% link content-services/7.0/develop/software-architecture.md %}#aikauintro)).
...
### Remote APIs
The main remote Application Programming Interface (API) is the [Alfresco ReST API]({% link content-services/7.0/develop/rest-api-guide/index.md %}),
...
Alfresco Repository. There are both a [Public Java API]({% link content-services/7.0/develop/reference/java-foundation-ref.md %}) and a Repository JavaScript API.
