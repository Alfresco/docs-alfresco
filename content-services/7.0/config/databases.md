...
Before continuing, check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver version for your chosen database.
...
3. [Install Content Services]({% link content-services/7.0/install/containers/index.md %})on your Amazon EC2 instance.

4. Install the Aurora database connector.

    This release requires `mysql-connector-java-5.x.x.jar` for compatibility with the SQL Server database. Check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver.
...
3. Install Content Services using one of the [options]({% link content-services/7.0/install/containers/index.md %}) provided.

4. Install the MySQL database connector.

    The MySQL database connector is required when installing with MySQL, and allows the MySQL database to talk to the server. Check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver.
...
4. Install the Microsoft SQL Server database connector to allow the database to talk to the server.
    ...
    Check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver version.
...
> **Note:** The Oracle Thin driver is recommended. Check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver.
...
1. Install the PostgreSQL database connector to allow the database to talk to the Content Services server.
    ...
    Check the [Supported platforms]({% link content-services/7.0/support/index.md %}) page for the correct driver.
