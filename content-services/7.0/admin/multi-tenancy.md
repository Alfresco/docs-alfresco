...
For more information on administration, see [Using the Repo Admin Console]({% link content-services/7.0/admin/admin-console.md %}) and [Using the Share Admin Tools]({% link content-services/7.0/admin/share-admin-tools.md %}).
