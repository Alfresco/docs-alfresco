...
For more information about `curl` and where to find it see this [page]({% link content-services/7.0/develop/rest-api-guide/install.md %}#http).

To check the global status of auditing, such as what audit applications that are enabled, see this [page]({% link content-services/7.0/develop/rest-api-guide/audit-apps.md %}#listauditapps).
...
Auditing can also be globally enabled or disabled for Audit applications, see this [page]({% link content-services/7.0/develop/rest-api-guide/audit-apps.md %}#enabledisableapp) for more info.
...
Once the sample files are enabled you can check that the new example audit applications are enabled via the ReST API, see this [page]({% link content-services/7.0/develop/rest-api-guide/audit-apps.md %}#listauditapps) for more information.
...
The Audit ReST API covers most of the audit functionality, check it out here in the [user guide]({% link content-services/7.0/develop/rest-api-guide/audit-apps.md %}).
...
The [Audit ReST API User Guide]({% link content-services/7.0/develop/rest-api-guide/audit-apps.md %}) contains a lot of example tutorials.
