...
* [Repo Admin Console]({% link content-services/7.0/admin/admin-console.md %}) for more information, specifically [support tools]({% link content-services/7.0/admin/support-tools.md %})
* [Share Admin Tools]({% link content-services/7.0/admin/share-admin-tools.md %}) to view various installation and setup information
...
1. Open the [Repo Admin Console]({% link content-services/7.0/admin/admin-console.md %}#launch-admin-console).
...
1. Go to [Share Admin Tools]({% link content-services/7.0/admin/share-admin-tools.md %}), and then click **Node Browser**.
...
See [Setting up clustering]({% link content-services/7.0/admin/cluster.md %}) for more information on the process of initiating clustering and the options available for configuring clustering.
