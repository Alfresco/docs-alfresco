...
For information about configuring metadata extractors, see [metadata extraction extension point]({% link content-services/7.0/develop/repo-ext-points/metadata-extractors.md %}).
