...
* **Share JAR**: [Project Structure]({% link content-services/7.1/develop/sdk.md %}#structureshare), [Generate Project]({% link content-services/7.1/develop/sdk.md %}#workingshare)
