...
See the [Event Gateway]({% link content-services/7.1/develop/oop-ext-points/event-gateway.md %}) documentation for more details.
...
See the [Install]({% link content-services/7.1/install/index.md %}) documentation for more details.
...
See the detailed [Upgrade]({% link content-services/7.1/upgrade/index.md %}) documentation, including the Content Services [upgrade paths]({% link content-services/7.1/upgrade/index.md %}#upgrade-paths).
...
See the [Extension Inspector]({% link content-services/7.1/develop/extension-inspector.md %}) documentation for more details.
...
See the [Supported Platforms]({% link content-services/7.1/support/index.md %}) for more details.

## SDK

The latest release of the [Alfresco in-process SDK]({% link content-services/7.1/develop/sdk.md %}) is SDK 4.3, which is compatible with this release.

The latest release of the [Alfresco out-of-process Event SDK]({% link content-services/7.1/develop/oop-sdk.md %}) is SDK 5.1, which is compatible with this release and the new [SDK Event Gateway]({% link content-services/7.1/develop/oop-ext-points/event-gateway.md %}).
