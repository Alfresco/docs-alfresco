...
As a developer you will need to be able to debug Content Services' product code, and custom code contained in [JARs/AMPs]({% link content-services/7.1/develop/extension-packaging.md %})
...
* [SDK 5 remote debugging]({% link content-services/7.1/develop/oop-sdk.md %}#debug-extension-project)
* [SDK 4 remote debugging]({% link content-services/7.1/develop/sdk.md %}#debugging)

## Introduction

Content Services is slightly more complex than the Hello World example above. Let’s see how to debug a ReST API call, 
such as the [login]({% link content-services/7.1/develop/rest-api-guide/install.md %}#auth) to get a ticket.
...
which is very useful when custom [JARs/AMPs]({% link content-services/7.1/develop/extension-packaging.md %}) should be applied.
...
ticket]({% link content-services/7.1/develop/rest-api-guide/install.md %}#auth) that can be used for authentication.
...
running Content Services based on a [ZIP installation]({%link content-services/7.1/install/zip/index.md %})), 
