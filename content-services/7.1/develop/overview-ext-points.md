...
The new [event system]({% link content-services/7.1/develop/oop-ext-points/events.md %}) in Content Services 7 enables 
out-of-process extensions. To support the event system a [ReST API Java Wrapper]({% link content-services/7.1/develop/oop-ext-points/rest-api-java-wrapper.md %}) 
is provided for easy development of extensions from Java applications.

You should get familiar with the [SDK 5]({% link content-services/7.1/develop/oop-sdk.md %}) as it is 
...
Repository, and UI extensions for the web client called Share. To get started see [Platform extensions overview]({% link content-services/7.1/develop/repo-ext-points/index.md %})
and [Share extensions overview]({% link content-services/7.1/develop/share-ext-points/index.md %}).

Also, you should get familiar with [SDK 4]({% link content-services/7.1/develop/sdk.md %}) as it is 
