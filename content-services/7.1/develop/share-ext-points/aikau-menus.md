...
[Surf Extension Module]({% link content-services/7.1/develop/share-ext-points/surf-extension-modules.md %}). 
...
* [Creating an Aikau page with Menus]({% link content-services/7.1/develop/share-ext-points/aikau-pages.md %}#createpagewithmenu)
...
* [Customizing the Admin Tools Menu]({% link content-services/7.1/tutorial/share/header.md %}#customizeadmintoolsmenu)
* [Customizing the Sites Menu]({% link content-services/7.1/tutorial/share/header.md %}#customsitesmenu)
* [Removing Menu Items]({% link content-services/7.1/tutorial/share/header.md %}#removemenuitem)
