...
but instead indirectly via either a [Surf Page]({% link content-services/7.1/develop/share-ext-points/surf-pages.md %}) 
or a [Surf Dashlet]({% link content-services/7.1/develop/share-ext-points/surf-dashlets.md %}). 
Surf web scripts are also used when constructing [Aikau Pages]({% link content-services/7.1/develop/share-ext-points/aikau-pages.md %}) 
and [Aikau Dashlets]({% link content-services/7.1/develop/share-ext-points/aikau-dashlets.md %}).
...
the Internet. To do this the controller uses a special root object called [remote]({% link content-services/7.1/develop/reference/surf-framework-ref.md %}#surfrootobjects), which 
...
Note the use of the `http` [connector]({% link content-services/7.1/develop/reference/surf-framework-ref.md %}#connectorsandcreds) 
...
It is more likely though that we would use this Web Scrip as a basis for a [Surf Dashlet]({% link content-services/7.1/develop/share-ext-points/surf-dashlets.md %}).
...
need to be called in context of a [Surf Page]({% link content-services/7.1/develop/share-ext-points/surf-pages.md %}) or a 
[Surf Dashlet]({% link content-services/7.1/develop/share-ext-points/surf-dashlets.md %}). Note the use of the `alfresco` 
[connector]({% link content-services/7.1/develop/reference/surf-framework-ref.md %}#connectorsandcreds) when communicating 
...
We should use the [v1 REST API]({% link content-services/7.1/develop/rest-api-guide/index.md %}) as much as possible, which requires a 
...
* [Surf root objects - controller]({% link content-services/7.1/develop/reference/surf-framework-ref.md %}#surfrootobjects) 
* [FreeMarker root objects - template]({% link content-services/7.1/develop/reference/freemarker-ref.md %})
...
* [Surf root objects]({% link content-services/7.1/develop/reference/surf-framework-ref.md %}#surfrootobjects)
...
* [Web Script tutorials]({% link content-services/7.1/tutorial/platform/web-scripts.md %})
