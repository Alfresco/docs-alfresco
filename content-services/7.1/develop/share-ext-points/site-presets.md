...
read the [Share architecture section]({% link content-services/7.1/develop/software-architecture.md %}#surf-framework). 
...
* [Adding a new Preset]({% link content-services/7.1/tutorial/share/pages.md %}#customizewscontroller) - this tutorial is not really about site presets, but it starts off by setting up a new user preset.
