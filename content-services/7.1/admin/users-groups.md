...
> **Note:** The Content Services repository would normally be connected to a directory service to sync users and groups into the database, see [Setting up authentication and sync]({% link content-services/7.1/admin/auth-sync.md %})

## Manage users

The **Users** tool in the Share **Admin Tools** lets you create and manage the user accounts.

See also Users tool [video tutorial]({% link content-services/7.1/tutorial/video/index.md %}#create-users)
...
See also Groups tool [video tutorial]({% link content-services/7.1/tutorial/video/index.md %}#create-groups).
