...
>**Note:** You can find additional admin tools in the [Repository Admin Console]({% link content-services/7.1/admin/admin-console.md %}).
...
1. Click **Admin Tools**.
    ...
    * Module Browser: [Viewing module packages]({% link content-services/7.1/install/zip/amp.md %}#viewing-module-packages)
    * Node Browser: [Using the Node Browser in Share Admin Tools]({% link content-services/7.1/admin/troubleshoot.md %}#using-the-node-browser)
    * Search Manager: [Manage search filters](#search-manager)
    * Tag Manager: [Managing tags](#tag-manager)
    * Model Manager: [Content modeling with Model Manager]({% link content-services/7.1/config/models.md %})
    * Sites Manager: [Sites Manager](#sites-manager)

    The remaining tools are grouped into the following categories:

    * Repository:
        * Replication Jobs: [Managing replication jobs]({% link content-services/7.1/admin/replication.md %})
    * Users and Groups:
        * Groups: [Managing groups]({% link content-services/7.1/admin/users-groups.md %}#manage-groups)
        * Users: [Managing users]({% link content-services/7.1/admin/users-groups.md %}#manage-users)
...
Take a look at this video to learn more: [Site Manager]({% link content-services/7.1/tutorial/video/sites.md %}#use-sites-manager)
...
Take a look at this video to learn more: [Search Manager]({% link content-services/7.1/tutorial/video/content.md %}#use-search-manager)
