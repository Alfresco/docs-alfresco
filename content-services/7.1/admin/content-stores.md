...
| Property | Description |
| -------- | ----------- |
| trashcan-cleaner.cron | Specifies the cron schedule for the Trashcan Cleaner job. See [Scheduled Jobs]({% link content-services/7.1/develop/repo-ext-points/scheduled-jobs.md %}). For example, `0 30 * * * ?`. |
...
The trashcan cleaner is a [Simple Module]({% link content-services/7.1/develop/extension-packaging.md %}#simplemodule) which appears in the Admin Console under the Module Packages section.
