...
In addition, the in-place bulk import provides support for [Managing the content store]({% link content-services/7.1/admin/content-stores.md %}#cs-selector). This allows you to select which store the content to import is to be found.
...
For more information about log4j, see [log4j.properties file]({% link content-services/7.1/develop/extension-packaging.md %}#log4jpropsfile).
