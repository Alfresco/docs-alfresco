...
3. Introduzca un término de búsqueda y haga clic en **Buscar**.
   ...
   > **Note:** Puede dejar vacío el campo de búsqueda para buscar todos los sitios disponibles.
...
Un administrador del sitio puede configurar características adicionales al [personalizar el sitio](#customizesite).
...
3. Haga clic en **Eliminar** para eliminarlo del sitio.
   
   Si lo prefiere, cambie el orden de las páginas que aparecen en Páginas del sitio actual, de forma que sea otra página la que aparezca en primer lugar (de izquierda a derecha). Esta página se convertirá en la página de inicio del sitio.

4. Haga clic en **Aceptar** para guardar los cambios efectuados.

En el sitio se muestra la nueva página de inicio.

Si lo desea, puede volver a añadir el panel de inicio del sitio más adelante.
...
Cuando un nombre de usuario, un nombre de sitio o un elemento se muestran con el formato de enlace, puede hacer clic en ellos para navegar a la página vinculada. When you hover over some dashlets additional options are displayed.
...
| Dashlet| Descripción
|----------|----------
|Miembros del sitio| Displays the current members of this site (to a maximum of 100 members) and their assigned roles.<br><br>Click a member’s name to view their user profile.<br><br>Click **All Members** to display all site members.<br><br>Click **Add Users** to add users this site. Esta opción solo está disponible para los administradores del sitio.
|Contenido del sitio| Lists the library content that has been added or edited in the past seven days.<br><br>Click a content item name or thumbnail to preview or work with that item in the library.<br><br>Select a view option: **Simple** or **Detailed**.<br><br>Mark an item as a favorite or remove it from the Favorites list (Detailed view only).<br><br>Like or unlike an item (Detailed view only).<br><br>Click the **Comment** link to add a comment on an item (Detailed view only).
...
6. Haga clic en **Aceptar** para guardar la configuración del panel de inicio.
...
Entre en un sitio y haga clic en **Miembros del sitio** para ver los miembros del sitio y buscar miembros específicos.
...
5. Haga clic en **Añadir usuarios**.
...
4. Haga clic en el rol actual y seleccione un nuevo rol de la lista.
