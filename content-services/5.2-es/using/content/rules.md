...
| **Enlace a categoría**| Enlaza ficheros o carpetas a la categoría que elija, como por ejemplo una región o una clasificación. See [Tagging and categorizing content]({% link content-services/5.2-es/using/content/manage.md %}#tagcategorizecontent) for more information.
