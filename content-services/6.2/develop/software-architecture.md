...
![acs_62_architecture_overview]({% link content-services/images/acs-6.2-enterprise-architecture-overview.png %})
...
* [Public Java API]({% link content-services/6.2/develop/reference/java-foundation-ref.md %})
...
The repository implements and exposes these services through an [Alfresco ReST API]({% link content-services/6.2/develop/rest-api-guide/index.md %})
