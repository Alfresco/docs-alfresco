...
6. Use [File and Folder Templates]({% link content-services/6.2/admin/templates.md %}) to create reusable components and enable business processes.
...
4. If you find yourself constantly creating the same space hierarchy as well as rules and aspects to them, consider creating [File and Folder Templates]({% link content-services/6.2/admin/templates.md %}) instead.
