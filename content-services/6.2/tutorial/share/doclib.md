...
**Extension Point**: [Document Library]({% link content-services/6.2/develop/share-ext-points/doclib.md %})
...
[here]({% link content-services/6.2/develop/share-ext-points/share-config.md %}#sharedoclib) before starting this tutorial. Also, familiar yourself with how 
[Surf Extension Modules]({% link content-services/6.2/develop/share-ext-points/surf-extension-modules.md %}) work as we will be creating one of those.
...
This tutorial assumes you have created a new [SDK All-In-One]({% link content-services/6.2/develop/sdk.md %}#workingaio) 
...
This tutorial assumes that you are familiar with the Document Library in Share. If you are new to it read up on it 
[here]({% link content-services/6.2/develop/share-ext-points/share-config.md %}#sharedoclib) 
...
5.  Now, log in to Share (http://localhost:8080/share) and you will see the new **Create... > Create an Acme Text Document** menu item as follows:
    ...
    See [here]({% link content-services/6.2/develop/repo-ext-points/permissions.md %}) for more information about how to create custom permissions.
...
**Extension Points**: [Surf Widgets]({% link content-services/6.2/develop/share-ext-points/surf-widgets.md %}) and [Surf Extension Modules]({% link content-services/6.2/develop/share-ext-points/surf-extension-modules.md %})
...
[Surf Extension Modules]({% link content-services/6.2/develop/share-ext-points/surf-extension-modules.md %}) 
...
see [Share Document Library]({% link content-services/6.2/develop/share-ext-points/share-config.md %}#sharedoclib) before starting this tutorial. Also, familiar yourself 
