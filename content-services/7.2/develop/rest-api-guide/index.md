...
2. [Install the ReST API Explorer]({% link content-services/7.2/develop/rest-api-guide/install.md %})
3. [Install a tool for making API calls]({% link content-services/7.2/develop/rest-api-guide/install.md %}#http)
4. [Install a tool to format JSON responses]({% link content-services/7.2/develop/rest-api-guide/install.md %}#json)
5. [Authenticate with the Repository to get a token]({% link content-services/7.2/develop/rest-api-guide/install.md %}#auth)
6. [Get Repository Info to see what is supported]({% link content-services/7.2/develop/rest-api-guide/get-repo-info.md %}) - which uses and tests the auth token
...
How to get a ticket and how to use it is explained [here]({% link content-services/7.2/develop/rest-api-guide/install.md %}#auth) 
