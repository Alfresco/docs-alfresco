...
>**Important:** For security reasons, only the following file types are allowed to be viewed in the browser: `.pdf`, `.png`, `.jpeg`, `.gif`, `.tiff`, `.bmp`. All other file types are instead downloaded. This is [configurable]({% link content-services/7.2/config/repository.md %}#conf-view-in-browser-mime-types).
