...
To check the global status of auditing, such as what audit applications that are enabled, see this [page]({% link content-services/6.0/develop/rest-api-guide/audit-apps.md %}#listauditapps).
