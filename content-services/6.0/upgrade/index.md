...
1. Install the new version of Content Services using the distribution zip.
    ...
    2. [Back up your existing repository]({% link content-services/6.0/admin/backup-restore.md %}) (`alfresco-v.1`) and the database.
...
3. Apply all customizations to the new 6.0.1 installation.
    ...
    2. [Remove]({% link content-services/6.0/install/zip/tomcat.md %}#tailor-your-installation) any unwanted applications.

    3. [Modify]({% link content-services/6.0/config/index.md %}#customize-applications) applications.

    4. Install the required AMP files. See [Installing an Alfresco Module Package]({% link content-services/6.0/install/zip/amp.md %}).
    ...
    6. [Start]({% link content-services/6.0/install/zip/additions.md %}#start-server) the server.
    ...
    8. [Stop]({% link content-services/6.0/install/zip/additions.md %}#stop-server) the server.
...
4. Restore production data.
    ...
    4. [Start]({% link content-services/6.0/install/zip/additions.md %}#start-server) the server.
