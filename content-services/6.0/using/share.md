...
There are a set of [video tutorials]({% link content-services/6.0/tutorial/video/index.md %}) related to Alfresco Share, including a [tour of the available features]({% link content-services/6.0/tutorial/video/index.md %}#tour-of-alfresco-share).
