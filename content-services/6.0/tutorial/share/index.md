...
* **Share JAR**: [Project Structure]({% link content-services/6.0/develop/sdk.md %}#structureshare), [Generate Project]({% link content-services/6.0/develop/sdk.md %}#workingshare)
