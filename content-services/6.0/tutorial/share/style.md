...
**Extension Point**: [Share Themes]({% link content-services/6.0/develop/share-ext-points/share-themes.md %})
...
[here]({% link content-services/6.0/develop/software-architecture.md %}#sharearchitecture) before starting this tutorial.
...
11. Now, log in to Share (`http://localhost:8080/share`) and set the new theme.
    ...
    You should also see a custom logo on each page. If you are also running with the [Share header customization]({% link content-services/6.0/tutorial/share/header.md %}) installed, then you will see that it overrides the theme customization:
