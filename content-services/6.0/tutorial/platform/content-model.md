...
Learn how to create a custom content model using the [Alfresco SDK]({% link content-services/6.0/develop/sdk.md %}).
...
See also [Content Model]({% link content-services/6.0/develop/repo-ext-points/content-model.md %}) extension point.
...
1.  Create a new [All-In-One SDK Project]({% link content-services/6.0/develop/sdk.md %}#gettingstarted).
...
4.  To build and run the project see [working with an AIO project]({% link content-services/6.0/develop/sdk.md %}#workingaio).
...
[Repo Web Script Extension Point]({% link content-services/6.0/develop/repo-ext-points/web-scripts.md %}).
...
3.  To build and restart the project see [working with an AIO project]({% link content-services/6.0/develop/sdk.md %}#workingaio).
...
6.  To build and restart the project see [working with an AIO project]({% link content-services/6.0/develop/sdk.md %}#workingaio).
...
3.  To build and restart the project so the modified model is picked up see [working with an AIO project]({% link content-services/6.0/develop/sdk.md %}#workingaio).
