...
([SDK archetypes introduction]({% link content-services/6.0/develop/sdk.md %}#mvnarchetypes)):

* **Platform JAR**: [Project Structure]({% link content-services/6.0/develop/sdk.md %}#structureplatform), [Generate Project]({% link content-services/6.0/develop/sdk.md %}#workingplatform)
* **All-in-One**: [Project Structure]({% link content-services/6.0/develop/sdk.md %}#structureaio), [Generate Project]({% link content-services/6.0/develop/sdk.md %}#workingaio)
