...
process as Content Services. This API is used to build extensions for the [Platform (Repository)]({% link content-services/6.0/develop/software-architecture.md %}#platformarch). 

## Getting started {#gettingstarted}
When we want to use one of the public Java APIs from an implementation of one of the Platform/Repository 
[Extension Points]({% link content-services/6.0/develop/repo-ext-points/index.md %}), 
...
other implementations, such as for [Repository Actions]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}) 
and Java-backed [Web Scripts]({% link content-services/6.0/develop/repo-ext-points/web-scripts.md %}). When we got the 
...
information about this see [Scheduled jobs]({% link content-services/6.0/develop/repo-ext-points/scheduled-jobs.md %}).
...
context files. You would instead use an [Alfresco In-Process SDK]({% link content-services/6.0/develop/sdk.md %}) project.
...
While Actions are typically triggered by [Rules]({% link content-services/6.0/using/content/rules.md %}), you can 
...
repository action implementation can be found [here]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}):
...
* [Repository Actions platform extension point]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}).
...
* [Audit platform extension point]({% link content-services/6.0/develop/repo-ext-points/audit-log.md %}).
* [Auditing]({% link content-services/6.0/admin/audit.md %}) provides a detailed overview of auditing.
...
* [Authentication & Sync documentation]({% link content-services/6.0/admin/auth-sync.md %})
...
* [Tagging and Categorizing Content]({% link content-services/6.0/using/content/manage.md %}#tagcategorizecontent)
* [Category Manager documentation]({% link content-services/6.0/admin/share-admin-tools.md %}#cat-manager)
...
## DictionaryService
This service gives you access to the [Content Model]({% link content-services/6.0/develop/repo-ext-points/content-model.md %}) 
...
code is executed inside a [Web Script]({% link content-services/6.0/develop/repo-ext-points/web-scripts.md %}) so it 
will automatically be part of a transaction using the `RetryingTransactionHelper`, same thing if the code was executed 
from a [Repository Action]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}).
...
See also the [Scheduled Jobs extension point]({% link content-services/6.0/develop/repo-ext-points/scheduled-jobs.md %})
...
The following example uses a [Web Script]({% link content-services/6.0/develop/repo-ext-points/web-scripts.md %}) 
...
See also the [Mimetype platform extension point]({% link content-services/6.0/develop/repo-ext-points/mimetypes.md %})

## ModuleService
A service to control and provide information about the currently-installed [Alfresco Module Packages (AMPs)]({% link content-services/6.0/develop/extension-packaging.md %}).
...
[view the currently installed Modules]({% link content-services/6.0/install/zip/amp.md %}#viewing-module-packages). 
...
See also [Custom Content Store platform extension point]({% link content-services/6.0/develop/repo-ext-points/content-stores.md %})
...
during node deletion. The following [node policies]({% link content-services/6.0/develop/repo-ext-points/behavior-policies.md %}) 
...
```
See also [Permissions platform extension point]({% link content-services/6.0/develop/repo-ext-points/permissions.md %})
...
* [Content Transformers and Renditions extension point]({% link content-services/6.0/develop/repo-ext-points/content-transformers-renditions.md %})
* [Mimetypes extension point]({% link content-services/6.0/develop/repo-ext-points/mimetypes.md %})
...
## SiteService
The `SiteService` provides an API for managing [Share Sites]({% link content-services/6.0/using/sites/index.md %}). 
...
[ReST API]({% link content-services/6.0/develop/rest-api-guide/sites.md %}#createsite).
...
Multi-tenancy is supported by the Alfresco repository. Read more about it [here]({% link content-services/6.0/admin/multi-tenancy.md %}). 
...
Alfresco provides the ability to apply [behavior policies]({% link content-services/6.0/develop/repo-ext-points/behavior-policies.md %}) 
...
## WorkflowService
Provides an interface to work with built in [workflows and tasks]({% link content-services/6.0/using/tasks.md %}). 
