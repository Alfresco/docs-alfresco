...
[authentication section]({% link content-services/6.0/admin/auth-sync.md %}) before proceeding so you are sure that there is not 
...
[this information]({% link content-services/6.0/admin/auth-sync.md %}#extauthconfig)).

Each authentication system that Content Services supports is implemented as a 
[subsystem]({% link content-services/6.0/develop/repo-ext-points/subsystems.md %}) that can be enabled and configured independently.
...
* [Authentication subsystems overview]({% link content-services/6.0/admin/auth-sync.md %}#configauthsubsystems)
* [Authentication chain]({% link content-services/6.0/admin/auth-sync.md %}#authchainconfig)
