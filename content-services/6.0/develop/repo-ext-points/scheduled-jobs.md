...
to be in the form of a [Repository Action]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}). Having the job implemented as a repository 
...
actions [here]({% link content-services/6.0/develop/repo-ext-points/repo-actions.md %}). We use the `ServiceRegistry` to get to the 
