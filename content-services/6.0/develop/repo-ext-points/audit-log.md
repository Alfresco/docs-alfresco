...
Further information can be found in the [Auditing Guide]({% link content-services/6.0/admin/audit.md %}).
...
For further information about Data Extractors [see this page]({% link content-services/6.0/admin/audit.md %}#dataextractor).
...
* [Auditing Alfresco]({% link content-services/6.0/admin/audit.md %})
...
* [Audit tutorials]({% link content-services/6.0/admin/audit.md %}#audittutorials)
