...
[Repository JavaScript root objects]({% link content-services/6.0/develop/repo-ext-points/javascript-root-objects.md %})
...
* [Spring Surf Root Object Reference]({% link content-services/6.0/develop/reference/surf-framework-ref.md %}#surfrootobjects) (Have a look at what root objects are already there)
