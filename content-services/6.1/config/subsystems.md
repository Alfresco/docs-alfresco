...
| -------------- | --------------- |
| [ActivitiesFeed]({% link content-services/6.1/config/email.md %}#configure-activities-feed) | Activities notifications |
| [Audit]({% link content-services/6.1/admin/audit.md %}) | Audit related functions |
| [Authentication]({% link content-services/6.1/admin/auth-sync.md %}) | Authentication related functions |
| [ContentStore]({% link content-services/6.1/admin/content-stores.md %}) | Properties for the encrypted and non-encrypted Content Stores |
| [email]({% link content-services/6.1/config/email.md %}) | Outbound and inbound SMTP property settings |
| [fileServers]({% link content-services/6.1/config/file-servers.md %}) | Properties for the FTP servers |
| [googledocs]({% link google-drive/3.1/index.md %}) | Properties for Google Docs integration |
| [imap]({% link content-services/6.1/config/email.md %}#configure-imap) | Properties for the IMAP service |
| [OOoDirect]({% link content-services/6.1/config/libreoffice.md %}#configure-openoffice) | OpenOffice transformations settings (use LibreOffice where possible) |
| [OOoJodconverter]({% link content-services/6.1/config/libreoffice.md %}) | Default settings for LibreOffice transformations |
| [Replication]({% link content-services/6.1/admin/replication.md %}) | Settings for the replication jobs tool |
| [Search]({% link search-services/1.4/index.md %}) | Search mechanism |
| [Subscriptions]({% link content-services/6.1/config/email.md %}#enable-subscription-service) | Settings for the activities feeds |
| [Synchronization]({% link content-services/6.1/admin/auth-sync.md %}#configuring-synchronization) | Synchronization of local user and group information with the user registry exporters (usually LDAP directories) in the authentication chain |
| [sysAdmin]({% link content-services/6.1/config/repository.md %}#sysadmin) | Properties for server administration |
| [thirdparty]({% link content-services/6.1/config/libreoffice.md %}#change-ooojodconverter) | Properties for third-party software, for example, ImageMagick |
| [Transformers]({% link content-services/6.1/admin/transformations.md %}) | Properties for the transformation server |
| [wcm_deployment_receiver]({% link content-services/6.1/admin/workflows.md %}#workflowconsole) | Properties for WCM Deployment Receiver |
...
* See [Modify global properties]({% link content-services/6.1/config/index.md %}#modify-global-props) for more information on how to configure a prepackaged subsystem.
* Use `-D` options
