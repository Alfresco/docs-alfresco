...
* Content Services 6.1.1 introduces changes that require new releases of all modules. To upgrade to 6.1.1, you also need to update any of the module artifacts to which you're entitled. See [Supported platforms]({% link content-services/6.1/support/index.md %}) for more details on the associated versions.
...
1. Install the new version of Content Services using the distribution zip.
    ...
    2. [Back up your existing repository]({% link content-services/6.1/admin/backup-restore.md %}) (`alfresco-v.1`) and the database.
...
2. Validate the new 6.1.1 installation to check that it's working correctly.
    ...
    2. [Start the server]({% link content-services/6.1/install/zip/additions.md %}#start-server) and [validate](#validate-upgrade) that the system works correctly.

3. Apply all customizations to the new 6.1.1 installation.

    1. [Stop]({% link content-services/6.1/install/zip/additions.md %}#stop-server) the server.

    2. [Remove]({% link content-services/6.1/install/zip/tomcat.md %}#tailor-your-installation) any unwanted applications.

    3. [Modify]({% link content-services/6.1/config/index.md %}#customize-applications) applications.

    4. Install the required AMP files. See [Installing an Alfresco Module Package]({% link content-services/6.1/install/zip/amp.md %}).
    ...
    6. [Start]({% link content-services/6.1/install/zip/additions.md %}#start-server) the server.
    ...
    8. [Stop]({% link content-services/6.1/install/zip/additions.md %}#stop-server) the server.
...
4. Restore production data.
    ...
    4. [Start]({% link content-services/6.1/install/zip/additions.md %}#start-server) the server.
