...
* **Platform JAR**: [Project Structure]({% link content-services/6.1/develop/sdk.md %}#structureplatform), [Generate Project]({% link content-services/6.1/develop/sdk.md %}#workingplatform)
