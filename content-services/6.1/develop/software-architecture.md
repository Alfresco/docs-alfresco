...
![acs_61_architecture_overview]({% link content-services/images/acs-6.1-enterprise-architecture-overview.png %})
...
* [ReST API]({% link content-services/6.1/develop/rest-api-guide/index.md %}).
* [Public Java API]({% link content-services/6.1/develop/reference/java-foundation-ref.md %})
...
The repository implements and exposes these services through an [Alfresco ReST API]({% link content-services/6.1/develop/rest-api-guide/index.md %})
...
The following diagram illustrates the platform architecture and [extension points]({% link content-services/6.1/develop/repo-ext-points/index.md %}).
...
and APIs, such as the [ReST API]({% link content-services/6.1/develop/rest-api-guide/index.md %}).
...
[content models]({% link content-services/6.1/develop/repo-ext-points/content-model.md %}).
...
client applications in any language using the [ReST API]({% link content-services/6.1/develop/rest-api-guide/index.md %}). You can create new
[content models]({% link content-services/6.1/develop/repo-ext-points/content-model.md %}) that define new content types, metadata,
and relationships. You can define [custom actions]({% link content-services/6.1/develop/repo-ext-points/repo-actions.md %}) that the repository
...
For more information see [content model introduction]({% link content-services/6.1/develop/repo-ext-points/content-model.md %}).
...
*[Extension Points]({% link content-services/6.1/develop/share-ext-points/index.md %})*, which are supported ways of injecting new
...
([Surf deep dive]({% link content-services/6.1/develop/reference/surf-framework-ref.md %})). This means that the
...
([Surf Reference]({% link content-services/6.1/develop/reference/surf-framework-ref.md %})). You will however mostly be dealing with component,
...
The full tutorial, and introduction to Surf Pages, can be found ([here]({% link content-services/6.1/develop/share-ext-points/surf-pages.md %})).
...
For a full tutorial and introduction to Aikau Pages, see ([Introduction to Aikau Pages]({% link content-services/6.1/develop/software-architecture.md %}#aikauintro)).
...
The main remote Application Programming Interface (API) is the [Alfresco ReST API]({% link content-services/6.1/develop/rest-api-guide/index.md %}),
