...
[Surf Web Scripts section]({% link content-services/6.1/develop/share-ext-points/web-scripts.md %}). The Dashlet will contain a Button that when clicked 
...
* [Customizing Surf Widget Instantiation]({% link content-services/6.1/tutorial/share/doclib.md %}#customizesurfwidget)
