...
[Surf Web Scripts section]({% link content-services/6.1/develop/share-ext-points/web-scripts.md %}). The controller of the dashlet presentation web script 
...
The controller makes use of a special root object called [remote]({% link content-services/6.1/develop/reference/surf-framework-ref.md %}#remoteapi), 
