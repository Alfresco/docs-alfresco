...
[Surf]({% link content-services/6.1/develop/software-architecture.md %}#surf-framework) is considered useful 
...
this new resource is in [jsNode reference.]({% link content-services/6.1/develop/reference/share-document-library-ref.md %}#jsnoderef)
...
See [EXIF renderer source code]({% link content-services/6.1/develop/reference/share-document-library-ref.md %}#exifrendref) for the complete source for this example.
...
You can also create your own themes. Take a look at the [Share Theme Extension Point]({% link content-services/6.1/develop/share-ext-points/share-themes.md %}) 
and the [Adding a custom Share Theme]({% link content-services/6.1/tutorial/share/style.md %}#addcustomtheme) tutorial.
...
For a description of the available form controls, refer to [Forms reference]({% link content-services/6.1/develop/reference/share-document-library-ref.md %}#formref).
...
* [Making custom types visible]({% link content-services/6.1/tutorial/platform/content-model.md %}#shareconfigtypesprops)
* [Making custom aspects visible]({% link content-services/6.1/tutorial/platform/content-model.md %}#addaspect)
