...
For information about configuring metadata extractors, see [Metadata Extractors]({% link content-services/6.1/develop/repo-ext-points/metadata-extractors.md %}).
