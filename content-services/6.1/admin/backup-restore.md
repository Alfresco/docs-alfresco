...
For backing up the Solr indexes using the Alfresco Share Admin Console or the `alfresco-global.properties` file, or JConsole, see [Backing up Search Services]({% link search-services/1.4/admin/index.md %}).
...
For more information on backing up Solr 6 indexes, see [Backing up Search Services]({% link search-services/1.4/admin/index.md %}).
