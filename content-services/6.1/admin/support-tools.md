...
With the **Support Tools** in the [Repo Admin Console]({% link content-services/6.1/admin/admin-console.md %}) you can monitor your Content Services system and diagnose performance, communication, and memory issues.
...
See [JMX monitoring and management extensions]({% link content-services/6.1/config/index.md %}#jmx-monitoring-and-management-extensions) for more information.
...
See [Troubleshooting schema-related problems]({% link content-services/6.1/admin/troubleshoot.md %}#troubleshoot-database-scheme-problems) for more information on how to manage schema-related issues.
...
You have the option to click **Run** to manually run individual scheduled jobs to ensure they're functioning correctly. See [Scheduled Jobs]({% link content-services/6.1/develop/repo-ext-points/scheduled-jobs.md %}) for more details.
