...
> **Note:** ActiveMQ is required when manually installing Content Services 6.1 onwards. For more information on installing and configuring ActiveMQ, see [Configuring ActiveMQ]({% link content-services/6.1/config/activemq.md %}).
