...
Categories can only be associated with library items and folders. Content needs to be enabled for categorizing before you can add it to a category, see [Managing Aspects]({% link content-services/latest/using/share/content/files-folders.md %}#applyaspects).
