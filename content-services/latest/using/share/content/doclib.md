...
2. By default items are shown in the **Detailed View**. Click **Options** to select a different view, see [Library Options](link ../concepts/library-options.md) for more details.
