...
You can either:
    ...
    * Press Enter (with the cursor in the search box) to view all the [search results](link search-results.md) for all files found by your search.
...
If you're a [Search Manager](link super-search-manager.md) super user then you'll have an additional **Search Manager** option you can click where you can create new search filters.
