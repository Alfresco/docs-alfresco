...
| Apache ActiveMQ | 5.16.4 | 5.16.1 | 5.16.1 | 5.15.14 | 5.16.1 |
...
| All-In-One T-Engine | 2.5.6 | 2.5.6 | 2.3.10 | 2.5.6 | 2.5.7 |
...
1. If you're not working directly on the control node, transfer the ZIP file to the control node together with the SSH 
   private key required to login to the target machines, and SSH into the machine:
