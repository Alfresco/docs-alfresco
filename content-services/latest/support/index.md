...
| Alfresco Search Enterprise 3.0 | For information about migrating from Alfresco Search and Insight Engine 2.0 or Alfresco Search Services 2.0 see the [Alfresco Search Enterprise 3.0 upgrade page](../../../search-enterprise/latest/upgrade/index.md). |
