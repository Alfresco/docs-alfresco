...
You can download the [alfresco-extension-inspector-2.3.0.jar](https://artifacts.alfresco.com/nexus/repository/releases/org/alfresco/extension-inspector/alfresco-extension-inspector/2.3.0/alfresco-extension-inspector-2.3.0.jar) file from the Alfresco Nexus repository.
