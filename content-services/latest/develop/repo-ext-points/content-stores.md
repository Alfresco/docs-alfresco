...
* **Amazon S3 content store** - store the files in an S3 bucket using the [Alfresco Content Connector for AWS S3](TODO_LINK:https://docs.alfresco.com/s3connector/concepts/s3-contentstore-overview.html).
