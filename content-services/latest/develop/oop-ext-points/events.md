...
It is possible to disable the events from being triggered and sent to ActiveMQ by setting `repo.event2.enabled=false`. This setting prevents any behaviors from being binded to the node creation/update/delete and permission changes.
