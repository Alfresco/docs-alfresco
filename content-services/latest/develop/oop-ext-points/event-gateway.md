...
For more information on how to use the subscription API, see the [Event Gateway documentation]({% link content-services/latest/develop/oop-sdk.md %}#using-event-gateway).
