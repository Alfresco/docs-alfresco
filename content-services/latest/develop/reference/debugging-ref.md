...
## Introduction
Content Services is slightly more complex than the Hello World example above. Let’s see how to debug a remote API call, 
such as for example a CMIS API that is called by a CMIS TAS Unit Test.
