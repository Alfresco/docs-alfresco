...
For information about configuring metadata extractors, see [Metadata Extractors](TODO_LINK:content-services/latest/develop/repo-ext-points/metadata-extractors.md).
