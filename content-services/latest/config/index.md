...
> **WARNING:** The JMX connection provides full access to the JVM and the Alfresco system running within it, **including the ability to execute code**. You should consider this connection the same level of access like a SSH connection with the user account running tomcat.
