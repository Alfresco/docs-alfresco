...
This tutorial assumes you have generated an [All-In-One SDK 3 project]({% link content-services/5.2/develop/sdk.md %}#workingaio).
...
In this tutorial you use the [SDK All-In-One]({% link content-services/5.2/develop/sdk.md %}#workingaio) project. The tutorial assumes you are using an IDE to edit the Maven project files. You should also be familiar with the [Introducing SurfBug]({% link content-services/5.2/develop/tools.md %}#surfbug) topic.
...
In this tutorial you add several customizations to the Share Header Menu. Your customization will be implemented as a [Surf Extension Modules]({% link content-services/5.2/develop/share-ext-points/surf-extension-modules.md %}).
...
5.  Run the [run.sh]({% link content-services/5.2/develop/sdk.md %}#workingaio) command to add your new Surf extension module.
...
7.  To build and run the updated Surf extension module see [working with an AIO project]({% link content-services/5.2/develop/sdk.md %}#workingaio).
...
4.  To build and run the updated Surf extension module see [working with an AIO project]({% link content-services/5.2/develop/sdk.md %}#workingaio).
...
9.  To build and run the updated Surf extension module see [working with an AIO project]({% link content-services/5.2/develop/sdk.md %}#workingaio).
