...
Site managers can easily add and remove features by [customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site)
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch the calendar on and off for a site.
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch the wiki on and off for a site.
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch the discussion forum on and off for a site.
...
## Deleting a topic {#deleting-a-blog-post}
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch the blog on and off for a site.
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch links on and off for a site.
...
> **Note:** See [Customizing a site]({% link content-services/5.2-de/using/sites/index.md %}#customizing-a-site) for how to switch data lists on and off for a site.
