...
This release of the Azure Connector is a compatibility release and only new libraries were added to the v2.0 code to support Alfresco Content Services 7.0.  

Other features introduced in previous versions include:

* [Azure content store subsystems]({% link microsoft-azure/2.0/config/index.md %}#azure-subsystems)
* [Multiple Azure storage container configuration]({% link microsoft-azure/2.0/config/index.md %}#configuring-multiple-storage-containers)
