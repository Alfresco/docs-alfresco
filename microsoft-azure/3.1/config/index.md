...
See [Azure Connector deleted content store]({% link microsoft-azure/3.1/install/index.md %}#azure-connector-deleted-content-store) for more details.
...
The sample files can be found in `alfresco-azure-connector-3.1.x.amp`.
