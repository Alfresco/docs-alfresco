...
> **Note:** See the [Supported Platforms]({%link microsoft-azure/latest/support/index.md %}) page for compatibility between Alfresco Content Connector for Azure 5.0.x and Alfresco Content Services.
