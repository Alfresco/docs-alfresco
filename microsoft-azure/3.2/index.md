...
* [Azure content store subsystems]({% link microsoft-azure/3.2/config/index.md %}#azure-subsystems)
* [Multiple Azure storage container configuration]({% link microsoft-azure/3.2/config/index.md %}#configuring-multiple-storage-containers)
...
* Accelerate local content download using [Direct Access URLs]({% link microsoft-azure/3.2/config/direct-access.md %})
* [Cloud Storage Properties]({% link microsoft-azure/3.2/config/index.md %}#cloud-storage-properties)
