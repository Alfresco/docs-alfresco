...
For more information on advanced ActiveMQ settings, see [Configure ActiveMQ](#LINK content-services/6.0/config/activemq.md) [Configuring advanced settings in ActiveMQ](LINK).
