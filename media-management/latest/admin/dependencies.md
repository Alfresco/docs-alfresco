...
|-------|---------------------|------------------------|
|IPTC metadata extraction|[FFmpeg](https://www.ffmpeg.org/) and MM Java|No|
...
|Remote video transcoding|[FFmpeg](https://www.ffmpeg.org/),[Zencoder](https://github.com/bitzeche/zencoder-java) and AWS (SDK through content services node)|Yes|
