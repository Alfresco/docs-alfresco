...
Alfresco Search Enterprise 3.2 consists of Alfresco Content Services, Elasticsearch Server, and the Elasticsearch connector. Use this information to install the Elasticsearch connector, which can be deployed using either JAR files, Docker Compose, or Helm.

## Prerequisites

* Alfresco Content Services 7.3 that includes Alfresco ActiveMQ, Alfresco Transform Service, and Database, for more see [Install overview]({% link content-services/latest/install/index.md %}).
...
See the [Supported platforms]({% link search-enterprise/3.2/support/index.md %}) for more.
...
1. Download the `alfresco-elasticsearch-connector-distribution-3.2.0.zip` file from [Hyland Community](https://community.hyland.com/){:target="_blank"} and extract it.  
...
> **Note:** Additional use cases are be covered in the [Administer]({% link search-enterprise/3.2/admin/index.md %}) documentation.
...
```java
java -jar alfresco-elasticsearch-live-indexing-3.2.0-app.jar
```
...
```java
java -Xmx2G -jar alfresco-elasticsearch-live-indexing-3.2.0-app.jar
```
...
```java
java -jar alfresco-elasticsearch-live-indexing-3.2.0-app.jar --server.port=8083
```
...
1. Download the `alfresco-elasticsearch-connector-distribution-3.2.0.zip` file from [Hyland Community](https://community.hyland.com/){:target="_blank"}.
