...
For more information, see [Configuring using the Admin Console]({% link search-enterprise/latest/config/index.md %}#configuring-using-the-admin-console) and [Secure Keys]({% link search-enterprise/latest/config/keys.md %}).
...
2. Copy the keystore and truststore files you created in [Generating secure keys for ssl communication]({% link search-enterprise/latest/config/keys.md %}#generating-secure-keys-for-ssl-communication) to the machine that's running the repository.
...
![admin]({% link search-enterprise/images/solr-admin.png %})
...
![logging]({% link search-enterprise/images/logging.png %})
...
![coreadmin]({% link search-enterprise/images/coreadmin.png %})
...
![java]({% link search-enterprise/images/javaproperties.png %})
...
![threaddump]({% link search-enterprise/images/threaddump.png %})
