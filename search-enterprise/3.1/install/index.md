...
See the [Supported platforms]({% link search-enterprise/3.1/support/index.md %}) for more.
...
> **Note:** Additional use cases are be covered in the [Administer]({% link search-enterprise/3.1/admin/index.md %}) documentation.
