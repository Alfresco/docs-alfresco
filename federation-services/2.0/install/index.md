...
Check the [supported platforms]({% link federation-services/2.0/support/index.md %}) for information on what you require before you start the installation.
...
3. After completing all the installation steps, you'll need to access the Admin app through your preferred browser to [configure]({% link federation-services/2.0/config/index.md %}) your installation.
