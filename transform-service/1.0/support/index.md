...
See [Install Transform Service]({% link transform-service/1.0/install/index.md %}#install-with-docker-compose) for more information.
...
See [Install Transform Service]({% link transform-service/1.0/install/index.md %}#install-with-helm-charts) for more information.
