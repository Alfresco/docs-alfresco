...
However, this is not the case if you're installing Alfresco Content Services using the distribution zip. See [Supported platforms]({% link transform-service/latest/support/index.md %}) for more information.
