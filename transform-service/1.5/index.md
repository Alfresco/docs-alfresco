...
* [Containerized deployment]({% link transform-service/1.5/install/index.md %}#containerized-deployments)
* [Distribution zip install]({% link transform-service/1.5/install/index.md %}#prereq-non-containerized-deploy)
