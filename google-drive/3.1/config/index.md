...
12. Launch the Administration Console by following the steps in [Launch Admin Console]({% link content-services/6.1/admin/admin-console.md %}#launch-admin-console).
