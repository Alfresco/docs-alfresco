...
The **Google Docs Console** provides the settings for enabling and controlling Google Docs Integration (in Enterprise-only releases). Launch the Administration Console by following the steps in [Launch Admin Console]({% link content-services/7.2/admin/admin-console.md %}#launch-admin-console).
