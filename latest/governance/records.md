...
|---------------------------------|---------------------------------------------------------------|-----------|
|![declare-file-as-record](../images/ic-declare-record-action.png)| |Click the icon to declare a file as a record.|
|![declared-as-record](../images/adw-record.png)|![declared-as-record](../images/ic-easy-access-record-small-scrn-size.png)|The file has been successfully declared as a record.|
|![rejected](../images/adw-record-rejected.png)|![rejected](../images/ic-record-alert.png)|The file has been rejected as a record. A message displays the reason why it was rejected. For example for having incomplete metadata.|
