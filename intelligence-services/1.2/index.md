...
> **Important:** The Intelligence Services module can be applied to Content Services 6.2 or later. See [Supported platforms]({% link intelligence-services/1.2/support/index.md %}) for more.

See [Intelligence Services architecture]({% link intelligence-services/1.2/admin/index.md %}) for a general overview.
