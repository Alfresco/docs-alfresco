...
> **Important:** The Intelligence Services module can be applied to Content Services 7.2 or later. See [Supported platforms]({% link intelligence-services/1.4/support/index.md %}) for more.

See [Intelligence Services architecture]({% link intelligence-services/1.4/admin/index.md %}) for a general overview.
