...
If the image file size is larger than 15 MB then it'll be skipped. See [Amazon Rekognition limits]({% link intelligence-services/1.0/admin/index.md %}#amazon-rekognition) for more.
...
See [Amazon Comprehend limits]({% link intelligence-services/1.0/admin/index.md %}#amazon-comprehend) and [Amazon Comprehend role]({% link intelligence-services/1.0/install/index.md %}) for more.
...
If the image file size is larger than 5 MB then it'll be skipped. See [Amazon Textract limits]({% link intelligence-services/1.0/admin/index.md %}#amazon-textract) for more.
...
You'll find a summary of the Transform Router configuration properties in `transformer-routes-with-ai.properties`, which is included in the Intelligence Services distribution zip file.

## I'm getting a lot of inaccurate metadata, what can I do?

The current default on minimum confidence levels is set at 80%.

See [Configuring the minimum confidence level]({% link intelligence-services/1.0/install/index.md %}#configure-minimum-confidence-level) for more.
...
See [Set up services in AWS]({% link intelligence-services/1.0/install/index.md %}) for more.
