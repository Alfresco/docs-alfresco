...
* [Amazon Textract](https://docs.aws.amazon.com/textract/latest/dg/what-is.html){:target="_blank"} for text detection and layout analysis

Alfresco Intelligence Services requests renditions for all three services (Comprehend, Rekognition, and Textract), however the API processing calls only take place for the relevant AWS service.

Before you can add these services to your deployment, some configuration is first required in AWS. The details are covered in the [installation guide]({% link intelligence-services/1.0/install/index.md %}).

## Analysis using AWS services

The following sections summarize the key features provided by each AWS service. The details are covered in the [installation guide]({% link intelligence-services/1.0/install/index.md %})
