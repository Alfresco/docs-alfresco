...
If the image file size is larger than 15 MB then it'll be skipped. See [Amazon Rekognition limits]({% link intelligence-services/1.3/admin/index.md %}#amazon-rekognition) for more.
...
See [Amazon Comprehend limits]({% link intelligence-services/1.3/admin/index.md %}#amazon-comprehend) and [Role-Based Permissions Required for Asynchronous Operations](https://docs.aws.amazon.com/comprehend/latest/dg/access-control-managing-permissions.html#auth-role-permissions){:target="_blank"} for more.
...
If the image file size is larger than 5 MB then it'll be skipped. See [Amazon Textract limits]({% link intelligence-services/1.3/admin/index.md %}#amazon-textract) for more.
...
See [Configuring the minimum confidence level]({% link intelligence-services/1.3/install/index.md %}#configure-minimum-confidence-level) for more.
...
See [Set up services in AWS]({% link intelligence-services/1.3/install/index.md %}) for more.
