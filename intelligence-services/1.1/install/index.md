...
* See [Supported platforms]({% link intelligence-services/1.1/support/index.md %}) for more
...
See [Install Intelligence Services]({% link intelligence-services/1.1/install/index.md %}) and [Configure Intelligence Services]({% link intelligence-services/1.1/config/index.md %}) for more.
...
* [Set up services in AWS]({% link intelligence-services/1.1/install/index.md %}#set-up-services-in-aws)
...
2. Next, [create an S3 bucket](https://docs.aws.amazon.com/AmazonS3/latest/gsg/GetStartedWithS3.html){:target="_blank"} to use with the Amazon AI Services.
    ...
    See [Clean up in S3]({% link intelligence-services/1.1/install/index.md %}#clean-up-in-s3) for guidance.
...
2. Extract the `alfresco-ai-distribution-1.1.x.zip` file into a system directory; for example, `<installLocation>/`.
