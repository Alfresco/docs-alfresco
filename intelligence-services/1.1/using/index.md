...
> **Note:** Before you can use a custom rendition, make sure that you've trained a custom model, deployed and configured one of the custom implementations listed in [Configure Intelligence Services]({% link intelligence-services/1.1/config/index.md %}).
...
11. Wait for the renditions to complete.
    ...
    See [Troubleshoot Intelligence Services]({% link intelligence-services/1.1/admin/troubleshoot.md %}) for more.

12. Next, [view the AI properties]({% link intelligence-services/1.1/using/index.md %}#view-ai-properties) in Alfresco Digital Workspace.
...
2. Select a rule action to perform.
    ...
    1. Add custom AI aspects, for example:
        ...
        See [Custom AI content model]({% link intelligence-services/1.1/config/comprehend.md %}#custom-ai-content-model) for configured aspects.
    ...
    2. Request custom AI renditions, for example:
        ...
        See [Custom AI rendition definitions]({% link intelligence-services/1.1/config/comprehend.md %}#custom-ai-rendition-definitions) for configured renditions.
    ...
    3. For custom metadata extraction (using Textract), request a rendition and add a custom AI aspects. For example:
        ...
        * Add aspect: `w9form`
        ...
        See [Custom AI content model (Textract)]({% link intelligence-services/1.1/config/textract.md %}#custom-ai-content-model) for configured aspects.
...
2. Locate the demo folder or subfolder, if the folder rule also applies to subfolders, as created in [Set up a folder rule]({% link intelligence-services/1.1/using/index.md %}#set-up-a-folder-rule).
