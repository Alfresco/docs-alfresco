...
2. Register the Microsoft Azure Bot:
   ...
   * Click **Review + create** (optionally you can add tags to your Bot):
     ...
     ![Bot Creation Checks passed]({% link facebook/images/azure-bot-create-checks-passed.png %}){:height="6500px" width="550px"}

   * If all pre-checks passed click **Create**.
   * Azure will deploy your registration.

     ![Bot Creation Complete]({% link facebook/images/azure-bot-deployment-complete.png %}){:height="200px" width="550px"}
...
3. Configure the OAuth connection to the ADW.
   ...
   ![Bot config]({% link facebook/images/azure-bot-configuration.png %}){:height="300px" width="600px"}
