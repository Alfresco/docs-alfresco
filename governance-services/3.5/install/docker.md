...
3. Edit the file and change the following two services:
    ...
    and add the Alfresco Governance image locations, change 3.4.x to 3.5.x version:
...
Final step before you can start with Records Management is to [create the Records Management site]({% link governance-services/3.5/install/create-rm-site.md %}).