...
Both of the AMP files need to be removed in order to uninstall Governance Services. Use the Module Management Tool (MMT) to do this. For more information on the tool, see [Module Management Tool (MMT)]({% link content-services/6.0/develop/extension-packaging.md %}#using-the-module-management-tool-mmt).
