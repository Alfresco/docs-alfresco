...
* [Install using Docker Compose]({% link governance-services/3.0/install/docker-compose/index.md %}) Due to the limited capabilities of Docker Compose, this deployment method is recommended for development and test environments only.
* [Install using the distribution ZIP]({% link governance-services/3.0/install/zip/index.md %})
