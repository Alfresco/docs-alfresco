...
You can also automate the File Plan by [applying rules to categories and folders]({% link governance-services/3.4/using/automate-fileplan.md %}). This means that records can be moved automatically through the record lifecycle, without you having to do any of the work.
...
>**Note:** Capabilities given to a role are not the same as permissions. Capabilities define what you can do in the Records Management site, whereas permissions are specific to sections of the File Plan. Permissions are applied at category and folder level using the **Manage Permissions** option, and you use these to decide which users can see specific sections of the File Plan, and if they can read and file in that section. See [Managing permissions]({% link governance-services/3.4/using/manage-permissions.md %}) for further details.
...
See also video explaining [adding a record category]({% link governance-services/3.4/tutorial/governance-services/index.md %}#create-a-record-category).
...
See also video explaining [adding a record folder]({% link governance-services/3.4/tutorial/governance-services/index.md %}#create-a-record-folder).  