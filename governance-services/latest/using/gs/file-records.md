...
>**Note:** You can also import folders, {% include tooltip.html word="category" text="categories" %}, and even entire File Plans, and any records that they contain, see [Exporting and importing File Plan content]({% link governance-services/latest/using/gs/manage-fileplan.md %}#exporting-and-importing-file-plan-content).
...
{% include governance-services/edit-record-metadata.md %}
