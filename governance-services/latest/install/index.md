...
>**Note:** For more information about what containerized deployment and Docker Compose means, see the Alfresco Content Services deployment documentation - [Understanding containerized deployment](TODO_LINK:https://docs.alfresco.com/6.2/concepts/deploy-overview.html).
