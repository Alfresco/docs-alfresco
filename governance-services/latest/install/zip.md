...
1. Browse to the [Support Portal](http://support.alfresco.com){:target="_blank"} and download `alfresco-governance-services-enterprise-distribution-7.1.0.zip`, which contains the following files:

    * alfresco-governance-services-enterprise-repo-11.153.amp
    * alfresco-governance-services-enterprise-share-11.77.amp
