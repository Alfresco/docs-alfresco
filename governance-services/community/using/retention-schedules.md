...
retention schedule is set to folder or record level, see [Actioning retention steps]({% link governance-services/community/using/manage-fileplan.md %}#processing-records).
...
See also video explaining [creating a retention schedule]({% link governance-services/community/tutorial/governance-services/index.md %}#create-a-retention-schedule).
...
See also video explaining [creating retention schedule steps]({% link governance-services/community/tutorial/governance-services/index.md %}#create-retention-schedule-steps).
