...
Download the Alfresco Governance Services distribution zip from [Hyland Community](https://community.hyland.com/){:target="_blank"}.

The Governance Services distribution zip contains the following AMP files:
