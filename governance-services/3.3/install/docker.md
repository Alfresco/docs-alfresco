...
3. Edit the file and change the following two services:
    ...
    Add a `#` prefix to the Alfresco Content Repository and Alfresco Share Docker image locations so they are commented out, and add the Alfresco Governance image locations, change 3.3.x to latest 3.3 version:
