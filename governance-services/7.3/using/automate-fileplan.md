...
7. Select the action you want performed when the conditions are met.
    ...
    If you select **Worm Lock** you must have configured Amazon S3. For more information on WORM Lock see [Working with Amazon S3 WORM]({% link governance-services/7.3/using/worm.md %})
