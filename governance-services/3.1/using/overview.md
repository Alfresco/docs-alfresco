...
If you're new to Alfresco then take a look at [Using Alfresco]({% link content-services/6.1/using/index.md %}) to help you get started.

For more details on setting up and administering Governance Services see [Administering Records Management]({% link governance-services/3.1/admin/index.md %}).
