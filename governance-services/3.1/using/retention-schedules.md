...
See also video explaining [creating a retention schedule]({% link governance-services/3.1/tutorial/governance-services/index.md %}#create-a-retention-schedule).
...
See also video explaining [creating retention schedule steps]({% link governance-services/3.1/tutorial/governance-services/index.md %}#create-retention-schedule-steps).
