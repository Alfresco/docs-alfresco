...
A Records Manager then has numerous options for [Filing an unfiled record]({% link governance-services/3.1/using/file-records.md %}#filing-an-unfiled-record) and 
[Managing unfiled records]({% link governance-services/3.1/using/manage-fileplan.md %}#managing-unfiled-records)
...
>**Note:** You can also [classify records]({% link governance-services/3.1/using/smc.md %}#classifyrecordsfolderscategories) in the File Plan.

See [Classification rules and tips]({% link governance-services/3.1/using/smc.md %}#classification-rules-and-tips) for more on classifying content.
...
18. Click security marks to apply them to the item, and again to remove them.
    ...
    See [How security controls work]({% link governance-services/3.1/using/smc.md %}#how-security-controls-work) for more details.
...
See also video explaining [declaring a file as a record]({% link governance-services/3.1/tutorial/governance-services/index.md %}#declare-an-easy-access-record).  
