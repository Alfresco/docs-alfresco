...
retention schedule is set to folder or record level, see [Actioning retention steps]({% link governance-services/7.1/using/manage-fileplan.md %}#processing-records).
...
See also video explaining [creating a retention schedule]({% link governance-services/7.1/tutorial/governance-services/index.md %}#create-a-retention-schedule).
...
See also video explaining [creating retention schedule steps]({% link governance-services/7.1/tutorial/governance-services/index.md %}#create-retention-schedule-steps).
