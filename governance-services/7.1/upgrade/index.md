...
2. Download Alfresco Content Services 7.1 or above and the Governance Services Distribution ZIP from [Hyland Community](https://community.hyland.com/){:target="_blank"}.
...
4. Apply the Governance Services to the upgraded Alfresco Content Services installation.
    ...
    Follow the instructions in [Install using the distribution ZIP]({% link governance-services/7.1/install/zip.md %}).
