...
> **Note:** You can also import folders, {% include tooltip.html word="category" text="categories" %}, and even entire File Plans, and any records that they contain, see [Exporting and importing File Plan content]({% link governance-services/7.2/using/manage-fileplan.md %}#exporting-and-importing-file-plan-content).
...
See also video explaining [filing an electronic record]({% link governance-services/7.2/tutorial/governance-services/index.md %}#file-a-record).
...
See also video explaining [filing an unfiled record]({% link governance-services/7.2/tutorial/governance-services/index.md %}#file-an-unfiled-record).
...
See also video explaining [adding record metadata]({% link governance-services/7.2/tutorial/governance-services/index.md %}#add-a-record-type).
...
See also video explaining [editing record metadata]({% link governance-services/7.2/tutorial/governance-services/index.md %}#edit-record-metadata).
...
> **Note:** A record can be filed in multiple categories, see [Linking records]({% link governance-services/7.2/using/manage-fileplan.md %}#linking-records) for more details.

See also video explaining [completing a record]({% link governance-services/7.2/tutorial/governance-services/index.md %}#complete-a-record).