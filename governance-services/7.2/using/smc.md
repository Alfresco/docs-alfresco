...
3. You are given the file permissions needed to edit [files]({% link content-services/latest/using/permissions.md %})/[records]({% link governance-services/7.2/admin/index.md %}#adding-users-and-groups-to-a-role).
...
> **Note:** Standard [Alfresco permissions]({% link content-services/latest/using/permissions.md %}) and [Records Management permissions]({% link governance-services/7.2/using/manage-permissions.md %}) continue to apply as well as any additional classifications.
...
> **Note:** Standard [Alfresco permissions]({% link content-services/latest/using/permissions.md %}) and [Records Management permissions]({% link governance-services/7.2/using/manage-permissions.md %}) continue to apply as well as any security clearance.
...
> **Note:** You can also [classify files]({% link governance-services/7.2/using/easy-access-records.md %}#classifying-files-and-folders) in Alfresco sites.
