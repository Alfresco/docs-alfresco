...
> **Note:** You must activate SSL when using Alfresco Office Services 1.2 or above. For more information, see [Configuring SSL]({% link content-services/6.1/config/repository.md %}#ssl-repo).
...
1. Install the AMP file `alfresco-aos-module-1.2.x.amp`. See [Install an AMP]({% link content-services/6.1/install/zip/amp.md %}) for information about installing an AMP file.
