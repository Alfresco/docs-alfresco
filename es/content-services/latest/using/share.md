...
> **Note:** Cuando un nombre de usuario, un nombre de sitio o un elemento se muestran con el formato de enlace, puede hacer clic en ellos para navegar a la página vinculada.

Each dashlet has a unique role:

| Dashlet| Role/Function
|----------|----------
| Mis Sitios| Lists the sites you belong to.<br><br>Click **Create Site** to start a new site.<br><br>Click a site name to go to that site.<br><br>Use the filter to display all sites, recent sites, or just your favorite sites.<br><br>Mark a site as a favorite or revoke its "favorite site" status.<br><br>Click the **Delete** icon to delete the site and its contents. (solo para administradores).
| Mis Actividades| Tracks the most recent activities in your sites.<br><br>Use the filters to specify the activities you want to see and for what time period.<br><br>Subscribe to the RSS feed to automatically receive activity updates.
...
> **Note:** Each dashlet includes help text. Position your cursor in the dashlet header to reveal the help button, then click it to display the related text. Este se queda abierto hasta que lo cierra o abandona el panel de inicio.
...
3. Navegue por las páginas de su perfil para ver y gestionar sus datos:
