...
The following query will give the disk space usage for each of the synchronization service tables and indexes:
...
**Parent topic:**[Installing and configuring PostgreSQL database for Desktop Sync](../tasks/postgres-config.md)
