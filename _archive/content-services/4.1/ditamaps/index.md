...
-   [Welcome](../concepts/welcome-infocenter.md)
    ...
    -   [Getting Started with Alfresco](../concepts/master-gs-intro.md)
        -   [Getting Started with Alfresco](../concepts/gs-intro.md)
            ...
            -   [Building a site](../concepts/gs-building-site.md)
                -   [Creating your first collaboration site](../tasks/gs-site-create.md)
                -   [Customizing the site dashboard](../tasks/gs-customize-dashboard.md)
                -   [Adding pages to a site](../tasks/gs-customize-site.md)
    ...
    -   [Administering](../concepts/ch-administering.md)
        ...
        -   [Managing content stores](../concepts/manage-cs-home.md)
            -   [The Content Store Selector](../concepts/store-manage-content.md)
    ...
    -   [Using Alfresco](../concepts/master-using-intro.md)
        -   [Using Alfresco Enterprise](../topics/sh-uh-welcome.md)
        ...
        -   [Using the Alfresco Outlook Client](../concepts/Outlook-intro.md)
