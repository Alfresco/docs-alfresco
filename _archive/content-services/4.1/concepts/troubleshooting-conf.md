...
-   If your cluster members are using NAT and IPv4 addresses, you may find it necessary to force the server to listen on IP V4 addresses rather than IP V6. To do this, add:
    ...
    For more information on the process of initiating clustering and the options available for configuring Alfresco clustering, see [Initiating clustering](../tasks/jgroups-repo.md).
