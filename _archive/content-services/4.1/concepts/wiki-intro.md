...
In both views \(wiki list and page view\) you can create, delete, view details for, and edit a wiki page. However, you must be in the page view to rename a wiki page.
