...
Your dashboard is made up of personal dashlets - each dashlet displays summary information on different parts of Alfresco, such as your latest updates, your tasks, or your Alfresco sites. There are two different sets of dashlets available - one set for your personal Alfresco dashboard and one set that is used to customize individual sites that you set up.

As well as adding and removing dashlets you can also customize your dashboard layout.

Managing your profile means that you can create a personality that is visible to other Alfresco users.
