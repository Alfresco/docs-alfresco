...
For specific information about the `propTablesCleanupTrigger` that you can scheduled to run database cleanup activities, see [Scheduling cleanup of database tables](prop-tables.md).
