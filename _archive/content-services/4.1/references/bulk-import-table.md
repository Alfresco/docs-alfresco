...
|Number of threads|`<numThreads>20</numThreads>`|Numeric|The number of threads specified for the bulk import|
...
|Duration|`<DurationInNS>0d 0h om 0s 96.941ms</DurationInNS>`|Alphanumeric|Time taken for the bulk import to complete. Format is xd xh xm xxs xxx.xxxms where x is a number|
