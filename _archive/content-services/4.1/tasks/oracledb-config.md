...
**Note:** The OCI driver is recommended over the Thin driver. Check the [supported platform](../concepts/alf3-supported-stacks.md) page for the proper driver and connection URL to use. For example, depending on the Oracle version, you may be required to use the oci or thin URL.
