...
The recommended path for upgrading Records Management is from Version 4.0.x to Version 4.1.10.

Once you are running version 4.0.x, use the standard upgrade process for Alfresco to upgrade to 4.1.10, and then when the Alfresco installation is upgraded, you can apply the new AMP files for Records Management 2.0.
...
2.  Download Alfresco Version 4.1.10 and the Records Management AMP zip from the [Support Portal](http://support.alfresco.com).

3.  Upgrade to Alfresco Enterprise 4.1.10.
...
Your existing Records Management data is migrated to 4.1.10.
