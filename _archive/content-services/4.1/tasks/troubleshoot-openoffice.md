...
3.  You may see a failure to connect error message, for example:
    ...
    If the OpenOffice process takes more than 30 seconds to fully start up, then Alfresco fails to connect to it. If this occurs, manually kill the soffice.bin process before attempting to restart the Jodconverter subsystem.
