...
Records Management 2.0 is supported with Alfresco Enterprise 4.1.10. Ensure that you have installed Alfresco Enterprise 4.1.10.

**Note:** For upgrading, your existing installation must be Alfresco 3.4.x or Alfresco 4.0.x, and then you can follow the standard upgrade process for the path to version 4.1.10 before you apply the AMPs for Records Management 2.0. See [Upgrading Records Management](rm-upgrade-proc.md).
...
3.  Log in to Alfresco Share to add the Records Management dashlet.
