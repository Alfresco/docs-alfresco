...
1.  Unzip the alfresco-kofax-client-binaries-4.1.10.zip  file to your Kofax Capture bin directory.

    For example, \(Windows\) c:\\Program Files\\Kofax\\CaptureSS\\ServLib\\bin
