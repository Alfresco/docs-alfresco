...
Ensure that you have applied the Alfresco Outlook Server AMP files. See [Installing Alfresco Outlook Integration](Outlook-amp.md) for more information. You also need your client and server license files.
