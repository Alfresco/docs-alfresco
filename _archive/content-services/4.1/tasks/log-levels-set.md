...
**Note:** A dev-log4j.properties file should never be used ongoing during production, nor packaged as a part of any product.
...
3.  Click **addLoggerMBean**.
    ...
    A dialog box displays with the title **Operation return value**. If the operation is successful, the body of the dialog box contains the **className** you provided, preceded by **log4j:logger=**. If the operation is unsuccessful, the body of the dialog box displays **null**.
