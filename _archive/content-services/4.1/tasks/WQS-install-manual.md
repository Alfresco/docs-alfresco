...
1.  Download the Web Quick Start zip bundle file:
    ...
    alfresco-enterprise-wcmqs-4.1.10.zip
...
3.  Copy the AMP files into the relevant amps directories for Alfresco and Share:
    ...
    1.  Copy the alfresco-enterprise-wcmqs-4.1.10.amp file to the amps directory.

    2.  Copy the alfresco-enterprise-wcmqs-share-4.1.10.amp file to the amps-share directory.
