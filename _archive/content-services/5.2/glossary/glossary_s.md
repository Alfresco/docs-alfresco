...
-   **SharePoint**
    ...
    Microsoft SharePoint is a web application platform and framework for collaborating and managing documents. Installing Alfresco Office Services \(AOS\) allows the Microsoft Office Suite applications \(for example, Word, PowerPoint, Visio and Excel\) to interact with Alfresco Content Services similar to SharePoint.
