...
-   **dashlet**
    ...
    A dashlet is an application that appears in the dashboard that presents information to the user. Users can organize dashlets into different layouts and set keyboard shortcuts for each dashlet.
...
-   **Day Zero**
    ...
    See the Day Zero Configuration Guide.
