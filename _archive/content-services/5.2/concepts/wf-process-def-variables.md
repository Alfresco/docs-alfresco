...
For example, the Alfresco Content Services supplied BPM task model defines the property **bpm:assignee**. To reference this property in your process definition you would specify the string **bpm\_assignee**. Note that the colon character is replaced by an underscore.
