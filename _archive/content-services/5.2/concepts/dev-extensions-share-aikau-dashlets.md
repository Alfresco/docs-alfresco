...
![](../images/dev-extension-points-aikau-dashlet-hello-world-dashlet.png)

This dashlet contains the following [Aikau Widgets](dev-extensions-share-aikau-widgets.md): the dashlet itself, two toolbar widgets, a vertical layout widget, a logo widget, and a Hello widget. To implement it start with the [Surf Web Script](dev-extensions-share-surf-web-scripts.md).
...
|
|[Deployment All-in-One SDK project](sdk-getting-started.md).|-   aio/share-jar/src/main/resources/alfresco/web-extension/site-webscripts - Aikau dashlet web scripts
