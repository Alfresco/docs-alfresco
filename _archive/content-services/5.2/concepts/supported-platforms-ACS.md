...
Choose a combination of products to build your own Supported Stack. If anything is unclear then please contact our Support team [https://support.alfresco.com](https://support.alfresco.com).
...
|MS SQL Server 2016|✓|✓|✓|✓|✓|✓|✓|✓|See [https://docs.microsoft.com/en-us/sql/connect/jdbc/system-requirements-for-the-jdbc-driver](https://docs.microsoft.com/en-us/sql/connect/jdbc/system-requirements-for-the-jdbc-driver) for JDBC Driver supported versions|
|MS SQL Server 2014|✓|✓|✓|✓|✓|✓|✓|✓|See [https://docs.microsoft.com/en-us/sql/connect/jdbc/system-requirements-for-the-jdbc-driver](https://docs.microsoft.com/en-us/sql/connect/jdbc/system-requirements-for-the-jdbc-driver) for JDBC Driver supported versions|
...
|Alfresco Outlook Integration 2.4|✓|✓|✓|✓|✓|✓|✓|✓|See [Outlook Integration prerequisites](http://docs.alfresco.com/outlook2.4/concepts/Outlook-reqs_v2.html) for MS-Office supported versions|
|Alfresco Outlook Integration 2.2|✓|✓|✓|✓|✓|✓|✓|✓|See [Outlook Integration prerequisites](http://docs.alfresco.com/outlook2.2/concepts/Outlook-reqs_v2.html) for MS-Office supported versions|
|Alfresco Outlook Integration 2.1|✓|✓|✓|✓|✓|✓|✓|✓|See [Outlook Integration prerequisites](http://docs.alfresco.com/outlook2.1/concepts/Outlook-reqs_v2.html) for MS-Office supported versions|
...
|Alfresco Sync Service 2.2 \*| | |✓|✓|✓|✓|✓|✓|See [Sync Service prerequisites](https://docs.alfresco.com/syncservice2.2/concepts/desktop-sync-prerequisites.html) for supported environments|
|Alfresco Sync Service 2.1 \*|✓|✓|✓|✓|✓|✓|✓|✓|See [Sync Service prerequisites](https://docs.alfresco.com/syncservice2.1/concepts/desktop-sync-prerequisites.html) for supported environments|
|Alfresco Desktop Sync 1.6 \*| | |✓|✓|✓|✓|✓|✓|See [Alfresco Desktop Sync overview](https://docs.alfresco.com/desktopsync/concepts/ds-overview.html) for supported clients|
|Alfresco Desktop Sync 1.5 \*| | |✓|✓|✓|✓|✓|✓|See [Alfresco Desktop Sync overview](https://docs.alfresco.com/desktopsync1.5/concepts/ds-overview.html) for supported clients|
|Alfresco Desktop Sync 1.4 \*| | |✓|✓|✓|✓|✓|✓|See [Alfresco Desktop Sync overview](https://docs.alfresco.com/desktopsync1.4/concepts/ds-overview.html) for supported clients|
