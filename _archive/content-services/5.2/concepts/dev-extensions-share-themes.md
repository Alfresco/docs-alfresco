...
|---------------|------------|
|Support Status|[Full Support](https://docs.alfresco.com/support/concepts/su-product-lifecycle.html)|
...
-   Yellow
 ...
 The default theme can be changed via the Share Admin Tools: ![](../images/dev-extensions-share-admin-console-change-theme.png)
...
|
|[Deployment All-in-One SDK project](sdk-getting-started.md)|-   aio/share-jar/src/main/resources/META-INF/themes - the theme's resource files goes here, pretty much the stuff you copy from alfresco/tomcat/webapps/share/themes
...
|
|Tutorials|-   [Adding a custom Share Theme](../tasks/dev-extensions-share-tutorials-add-theme.md)
