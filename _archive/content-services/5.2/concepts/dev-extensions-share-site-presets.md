...
|[Deployment All-in-One SDK project](sdk-getting-started.md)|aio/share-jar/src/main/resources/alfresco/web-extension/site-data/presets/presets.xml|
|More Information| |
|Tutorials|-   [Adding a new Preset](../tasks/dev-extensions-share-tutorials-js-customize.md) - this tutorial is not really about site presets, but it starts off by setting up a new user preset.
