...
For a full tutorial and introduction to Aikau Pages, see \([Introduction to Aikau Pages](dev-extensions-share-architecture-extension-points-intro-aikau-pages.md)\).
...
Here is a list of each supported extension point in Share, for a comprehensive description of each one go to the [Share Extension Points](dev-extensions-share-extension-points-introduction.md) section \(OOTB = Out-of-the-box functionality\):
