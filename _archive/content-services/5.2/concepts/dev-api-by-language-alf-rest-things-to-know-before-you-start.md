...
You can find more information about the API Explorer on [this page](dev-api-by-language-alf-rest-install-api-explorer.md), which also has information on how to install it for your specific version of ACS.
...
![](../images/dev-api-by-language-alf-rest-acs-required-version-1.png)

Note that an API endpoint can be supported from a specific patch version of ACS, such as in the following screenshot:

![](../images/dev-api-by-language-alf-rest-acs-required-version-2.png)
...
How to get a ticket and how to use it is explained [here](dev-api-by-language-alf-rest-auth-with-repo.md) in the ReST API user guide.
