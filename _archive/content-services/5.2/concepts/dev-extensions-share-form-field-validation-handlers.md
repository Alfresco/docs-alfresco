...
|[Deployment All-in-One SDK project](sdk-getting-started.md).|-   aio/share-jar/src/main/resources/META-INF/resources/share-jar/js/\{custom path\} - validation handler JavaScript files
