...
For more information about the web scripts that you invoke to script a bulk import, see [Bulk importing using the user interface](bulk-import-via-the-ui.md).
