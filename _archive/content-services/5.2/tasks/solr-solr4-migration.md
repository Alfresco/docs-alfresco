...
1.  Upgrade to Alfresco Content Services 5.2.7  and continue to use the Solr 1.4 search service as before.
    ...
    For information on migrating the Solr 1.4 indexes with Alfresco Content Services 4.x to Solr 1.4 with Alfresco Content Services 5.2.7, see [Upgrading Solr 1.4 search service](upgrade-solr1.md).

2.  Configure Solr 4 to track the repository. For details, see [Installing and Configuring Solr 4](solr4-install-config.md).
