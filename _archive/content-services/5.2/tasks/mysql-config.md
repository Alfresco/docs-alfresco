...
2.  Create a database named alfresco.
    ...
    **Note:** You also must ensure that the MySQL database is set to use UTF-8 and InnoDB. Refer to [Optimizing MySQL to work with Alfresco Content Services](../concepts/mysql-config-settings.md).
