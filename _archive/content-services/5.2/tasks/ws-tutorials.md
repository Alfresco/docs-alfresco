...
These tutorials assume you have Alfresco Content Services installed locally at http://localhost:8080. If this is not the case you will need to amend the URLs used in the tutorials accordingly.
...
A Folder Listing Java-backed web script mimics the behavior of the `dir` command in Microsoft Windows, or `ls` in Linux and Mac OS X.
