...
1.  Create the Java class for the Folder Listing web script:
    ...
    6.  Place the compiled Java class into the folder **<install\_dir\>/tomcat/webapps/alfresco/WEB-INF/classes/org/example**.
...
2.  Create the Spring Framework configuration for registering your web script Java class:
    ...
    3.  Place the Spring Framework configuration file into the extension classpath of the Alfresco Content Services server, in this case <install\_dir\>/tomcat/shared/classes/alfresco/extension/javadir-context.xml.
