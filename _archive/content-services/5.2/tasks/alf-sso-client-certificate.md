...
1.  Setup Apache as proxy server in front of Alfresco Content Services and configure it to use SSL as described in [Configuring SSL for a production environment](configure-ssl-prod.md).
