...
2.  Generate certificates that will be used for Solr and Alfresco Content Services communication. The <ALF\_DATA\>\\keystore\\generate\_keystores.bat can be used, the only requirement is to use JKS keystores and truststores, as JBoss does not support JCEKS.
