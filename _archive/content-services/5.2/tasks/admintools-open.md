...
# About the Alfresco Share Admin Tools
...
1.  Click **Admin Tools**.
    ...
    -   **Application**: [Managing Alfresco Share features](../concepts/manage-share.md)
...
**Parent topic:**[Using the Alfresco Share Admin Tools](../concepts/admintools.md)
