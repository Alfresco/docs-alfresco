...
|
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   aio/platform-jar/src/main/resources/alfresco/extension/templates/webscripts/\{domain specific directory path\} - Descriptor, JavaScript controller, template, properties files, configurations
