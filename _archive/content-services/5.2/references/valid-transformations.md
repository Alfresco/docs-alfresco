...
|`transformer.strict.mimetype.check.whitelist.mimetypes`|Specifies the pair of detected and declared mimetypes \(separated by semicolons\) that are allowed. For example:```
transformer.strict.mimetype.check.whitelist.mimetypes=application/eps;application/
postscript;application/illustrator;application/pdf;application/x-tar;application/
x-gtar;application/acp;application/zip;application/vnd.stardivision.math;application/
x-tika-msoffice
```
