...
```
 ...
 Note that while MD4 is the default encoding format for passwords, there is additional support for Bcrypt. For more information about Bcrypt support, see [Cryptographic password hashing](../concepts/bcrypt-overview.md).
...
```
 ...
 Besides using patches to bootstrap content there is also the `ImporterModuleComponent` that can be used to bootstrap/import content into the Repository, for more information about this see [Module Components](dev-extension-points-module-component.md).
...
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   XML, ACP, and content files: aio/platform-jar/src/main/resources/alfresco/module/platform-jar/bootstrap
...
-   [Bootstrap ACP with Importer component](../concepts/dev-extensions-modules-importing-module-data.md). See also: [Import strategy](../concepts/dev-extensions-modules-import-strategy.md)
