...
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   aio/platform-jar/src/main/java/\{custom package path\} - Java form processor implementation, including supporting classes for field, item etc.
