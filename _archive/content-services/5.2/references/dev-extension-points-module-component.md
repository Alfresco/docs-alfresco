...
For more information about bootstrapping content see this [extension point](dev-extension-points-bootstrap.md).
...
|
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   aio/platform-jar/src/main/java/\{custom package path\} - implementation of module components
...
|
|More Information|-   [Import / Bootstrap content with module](../concepts/dev-extensions-modules-importing-module-data.md)
-   [More bootstrap information](dev-extension-points-bootstrap.md)
