...
|
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   aio/platform-jar/src/main/resources/alfresco/extension/templates/webscripts/org/alfresco/enterprise/repository/admin/\[general\|support-tools\|consoles\|email-services\|repository-services\|user-directories\|virtual-file-systems\|\{custom section id\}\] - Descriptor, JavaScript controller, template, properties files
