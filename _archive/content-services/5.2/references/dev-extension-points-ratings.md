...
-   **fiveStarRatingScheme** - The scheme allows users to rate content on a scale from 1 to 5
 ...
 Let's start by defining the [Document Library](../concepts/dev-extensions-share-doclib-actions.md) action \(note that this is not a repository extension but should be part of a Share extension JAR, such as the one that is part of an [All-in-One SDK project](../concepts/sdk-getting-started.md)\):
...
```
 ...
 The [Repository Action](dev-extension-points-actions.md) implementation look like this \(this should be contained in a Repository JAR, such as the one contained in an [All-in-One SDK project](../concepts/sdk-getting-started.md)\):
...
|
|[Deployment All-in-One SDK project](../concepts/sdk-getting-started.md).|-   **Share:**
