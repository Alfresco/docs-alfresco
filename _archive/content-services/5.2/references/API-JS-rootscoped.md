...
See also [Web script reference guide, which covers root objects in more detail.](../concepts/ws-reference.md)
...
[Web script reference guide](../concepts/ws-reference.md)
