...
If you have installed a transform tool, such as Alfresco Outlook Integration, Transformation Server, or Alfresco Media Management, there are additional transform options, which are listed in [Additional transform options](additional-transformations.md).
