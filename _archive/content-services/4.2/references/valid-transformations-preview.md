...
The following table shows the file types that support these capabilities. See [Available transform options](valid-transformations.md) for a full listing of formats.

## Formats that support preview and thumbnail generation

|Format|File type extension|Supports preview \(swf\)|Supports thumbnail \(jpg\)|
|------|-------------------|------------------------|--------------------------|
