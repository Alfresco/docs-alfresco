...
1.  Select the folder in the document library where you want to add your content.
    ...
    When you select a folder in the explorer panel the item list displays the current contents of that folder. When using the **Upload** action the item\(s\) you select will be added here.
...
The item list displays the uploaded content.
