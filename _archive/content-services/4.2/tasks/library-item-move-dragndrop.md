...
1.  In the library click the thumbnail of the item or folder you want to move. Don't release the mouse button.
...
3.  Release the mouse button to move the content.
    ...
    **Important:** To move several items or folders at once, or to move content to another site library, use the **Move to** action.
