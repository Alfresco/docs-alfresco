...
The default is 100.|
    ...
    |**Sync Changes Only**|Yes|This triggers a differential synchronization. Deselect this option, to run full synchronization. Regardless of this setting, a differential synchronization may still be triggered when a user, who does not yet exist in Alfresco, is successfully authenticated.|
...
**Parent topic:**[Managing authentication chain](../tasks/adminconsole-directorymgt-ac.md)
