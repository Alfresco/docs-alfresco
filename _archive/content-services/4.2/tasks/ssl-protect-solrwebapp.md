...
-   [Alfresco Report](../concepts/alfresco-reports.md)
...
The **Alfresco Report** page is displayed when you click on the **Alfresco Report** link. This page is used to judge the relative health of the indexes.
