...
# Installing Solr on JBoss 6 EAP with Java 7

This section describes how to install Solr on the same JBoss 6 instance on which Alfresco has been installed.

**Important:** The Alfresco Solr application is supported on JBoss **ONLY** for Alfresco Enterprise version 4.2.2. The Alfresco Solr application is not supported on JBoss for Alfresco Enterprise 4.2.1, 4.2.0 or older versions. For more information, refer to [Supported Platforms for Alfresco Enterprise 4.2.x](http://www.alfresco.com/services/subscription/supported-platforms).

Ensure that JBoss and JDK7 are installed. Review the Supported Platforms page on the [Support Portal](http://support.alfresco.com) for more information.
...
2.  Download the alfresco-enterprise-solr-4.2.8.zip file.
...
4.  Create a JBoss module with Solr configuration.
    ...
    15. Unzip the alfresco-enterprise-4.2.7.ear\\alfresco.war file and add the security domain to WEB-INF\\jboss-web.xml:
    ...
    16. Compress the Alfresco WAR and alfresco-enterprise-4.2.7.ear files as we have made changes to it.
