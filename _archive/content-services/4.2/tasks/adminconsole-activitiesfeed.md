...
3.  Set the activities properties:
    ...
    |**Maximum Number**|100|The maximum number of activities that are reported on in the Activities dashlets and Activities Feed emails.|
    |**Maximum Age \(mins\)**|44640|This is the maximum age of the activities shown in the Activities Feed emails. Activities older than the maximum age are not shown in the Activities dashlet. The default setting is 44640 \(a 31-day month\).|
