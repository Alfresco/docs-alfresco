...
4.  Create a sub-package \(skip this step if the **example** space already exists\):
    ...
    5.  Navigate to **Company Home \> Data Dictionary \> Web Scripts Extensions \> org \> example**.
...
**Note:** It is also possible to create these files as stand-alone filesusing an external text editor. Once these files are created you could locate them as follows:
