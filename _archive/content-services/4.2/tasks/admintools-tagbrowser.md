...
1.  Click **Admin Tools**, and then click **Tag Manager**.
    ...
    When you hover over the right hand **Actions** column, you see the available action icons for: **Edit tag** \(![Edit](../images/ico-configure.png)\) and **Delete tag** \(![Delete](../images/ico-delete.png)\).
...
See [Tagging and categorizing content](site-content-tag.md) for more about using tags.
