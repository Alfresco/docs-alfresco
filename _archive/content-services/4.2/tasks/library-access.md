...
1.  In a site click **Document Library** to access the library.
    ...
    **Note:** In each site the component names can be customized. If the site manager has done this, the link in the navigation bar may have a label other than **Document Library**.
