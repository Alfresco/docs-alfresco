...
1.  Hover over an item in the library and click **More** then **Edit in Google Docs**.
    ...
    **Note:** If you previously locked the file for editing and are returning to it, you'll have the action **Resume Editing in Google Docs**.
    ...
    The item opens in Google Docs in a new browser tab. It's locked in Alfresco so that other users can't edit it while you're working on it. The item stays locked until you either discard or save your changes.
