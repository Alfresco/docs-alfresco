...
3.  Click **Select** beneath the **Web Assets** label to edit the content associated with the carousel. You can add and remove assets.
    ...
    On the Select page, the right column displays the assets already associated with the carousel. The left column displays the repository structure, which you navigate to locate the desired assets.
