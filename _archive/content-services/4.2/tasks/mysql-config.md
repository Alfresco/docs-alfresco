...
6.  Navigate to the <ALFRESCO\_HOME\>/alf\_data/ directory and empty the <contentstore\> directory.
    ...
    This is because the contentstore must be consistent with the database. Since, we have created an empty database in Step 2, we must empty the contentstore.
