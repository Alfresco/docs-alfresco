...
The Directory Management page is divided into the following four sections. Click each section for more information.

-   [Authentication Chain](../tasks/adminconsole-directorymgt-ac.md)
-   [CIFS Authentication](../tasks/adminconsole-directorymgt-cifs.md)
-   [Browser Based Automatic Login](../tasks/adminconsole-directorymgt-sso.md)
