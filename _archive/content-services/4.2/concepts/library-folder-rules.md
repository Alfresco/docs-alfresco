...
-   All items placed in the *Drafts* folder are versioned
-   All items placed in the *Drafts* folder become part of a simple workflow
-   All items placed in the *Completed* folder that have the tag *final* will be moved to the folder *Archived*
