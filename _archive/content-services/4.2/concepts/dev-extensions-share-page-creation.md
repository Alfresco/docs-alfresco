...
This now creates a basic menu bar with two menu items.
...
The result displays a drop down menu.
...
Once the web scripts are refreshed and the page is reloaded you will see a page displaying a menu with dropdowns, cascaded menus and icons.

## The Hybrid Page

There is also the availability of the "hybrid" view of the page. By simply changing the URL to be `http://<server>:<port>/share/page/hdp/ws/my-new-page` \(note the additional "h"\) you will get the page content rendered between the standard Share header and footer.

## Summary and Next Steps

This topic has shown that it is possible to develop widgets using JSON models.
