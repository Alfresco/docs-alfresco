...
2.  Add the following somewhere in your Tomcat configuration. For example, `/etc/tomcat5/tomcat5.conf`.
...
**Note:** This method explains how to create a self-signed certificate only. SSL vendors can provide certificates signed by an authority and may be more suitable for production use.
