...
Aspects use properties to enhance the content types. You can attach behaviors and workflows to aspects. The following table lists the aspects available in Alfresco.
...
|Complianceable|This aspect is no longer valid. For compliance-related behavior, please use Alfresco's Record Management module.| |
...
|
|Effectivity|This aspect is no longer valid. For compliance-related behavior, please use Alfresco's Record Management module.|
