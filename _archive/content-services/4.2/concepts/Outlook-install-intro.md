...
For more information about installing and configuring Alfresco Outlook Integration, see [Installing and configuring Alfresco Outlook Integration 2.0](http://docs.alfresco.com/outlook2.0/concepts/Outlook-install-intro.html).

Version 1 of Alfresco Outlook Integration is supported with Alfresco One 4.2.5 and earlier only, and has a reduced set of features. See [Alfresco Outlook Integration 1.1](http://docs.alfresco.com/outlook1.1/concepts/Outlook-overview_v1.html) for previous releases of Outlook Integration.
