...
-   **kerberos.authentication.browser.ticketLogons**
    ...
    Authentication with Alfresco using a ticket parameter in the request URL. The default value is `true`. Note that WebDAV URLs always accept ticket parameters.
