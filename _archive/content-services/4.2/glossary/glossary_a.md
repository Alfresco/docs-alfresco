...
-   **Alfresco Community**
    ...
    Alfresco Community Edition is the open source alternative for Enterprise Content Management. Distributed under the LGPLv3 license, it is free to download and use forever. Alfresco Community has limits in terms of scalability and availability and is not supported, which makes it best suited for developers and technical enthusiasts in non-business critical environments.
...
-   **Alfresco DocLib portlets**

    DocLib portlets provide the document management capabilities of the Share Document Library page component within a Liferay portal. This feature consists of three portlets for accessing Share sites and the Alfresco repository.
