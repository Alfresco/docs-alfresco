...
-   **MIME type**
    ...
    A MIME type has two parts: a type and a subtype. They are separated by a forward slash \(/\). For example, the MIME type for Microsoft Word files is application and the subtype is msword. Together, the complete MIME type is application/msword. Source: [What is a MIME type?](http://http://www.aibn.com/help/Learn/mimetypes.html)
