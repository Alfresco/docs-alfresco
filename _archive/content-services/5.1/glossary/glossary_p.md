...
-   **Pentaho Business Analytics \(BA\) Server**
    ...
    Pentaho provide business analytics capabilities in the Pentaho BA server. This is used to process information and create reports in Alfresco Analytics. For more information, see [http://docs.alfresco.com/analytics/concepts/analytics-architecture.html](http://docs.alfresco.com/analytics/concepts/analytics-architecture.html).
