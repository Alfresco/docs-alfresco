...
4.  Set the configuration properties.
    ...
    |**Map Unknown User to Guest**|No|This specifies whether unknown users are automatically logged in as the Alfresco guest user during SSO.|
    |**Allow Guest Login**|No|This enables the guest logins to Alfresco.|
