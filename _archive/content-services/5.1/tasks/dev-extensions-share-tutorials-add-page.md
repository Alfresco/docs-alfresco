...
# Adding a new Surf page to Alfresco Share
...
5.  Create a new file in config/alfresco/templates/tutorials called home-page.ftl with the following contents:
    ...
    This is the FreeMarker template file. This contains the actual page content. The example shown here is trivial but this could also contain regions for binding Alfresco Surf components if required.
