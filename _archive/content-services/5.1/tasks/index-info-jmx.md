...
The JMX view of all the instancess, shards, and indexes that stick together is displayed at the **MBeans \> Alfresco \> FlocAdmin \> Attributes \> Flocs** node. The **Flocs** node displays a tabular view of all the indexes formed by shard instances by registering with any member of the Alfresco cluster.
...
3.  Double-click on the Alfresco Java process.
