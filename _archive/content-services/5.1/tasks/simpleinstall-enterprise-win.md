...
# Installing Alfresco on Windows using the Alfresco One Installer

The setup wizard for Microsoft Windows installs all the software and components that you require for running Alfresco. This setup wizard installs Alfresco and additional software, including a Tomcat application server, PostgreSQL database, JRE, and LibreOffice.
...
1.  Download the following installation file:
    ...
    alfresco-one-installer-5.1.5-win-x64.exe
...
8.  On the Installation Folder window, click Next to accept the default location.
    ...
    For example, the default location is C:\\alfresco-one.
...
15. On the Alfresco RMI Port window, enter a port number for the RMI service, and then click **Next**.

16. On the Admin Password window, enter a password. Repeat the password, and then click **Next**.
...
20. On the Completing the Alfresco One Setup Wizard window, click **Finish**.
...
22. Log on to Alfresco as the `admin` user. Enter the password that you specified in the Admin Password window.
    ...
    -   `alfrescoPostgreSQL`
    -   `alfrescoTomcat`
    If you did not automatically launch Alfresco at the end of the installation wizard, to start Alfresco, you need to start all the services. Use the servicerun start script in the installation directory or select **All Programs \> Alfresco One \> Alfresco One Service \> Start Alfresco One Service**.

23. To fully stop Alfresco, you must stop all the services. Use the servicerun stop script in the installation directory or select **All Programs \> Alfresco One \> Alfresco One Service \> Stop Alfresco One Service**.
