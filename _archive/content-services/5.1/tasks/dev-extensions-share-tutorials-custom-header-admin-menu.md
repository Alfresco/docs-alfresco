...
In this tutorial you add several customizations to the Share Header Menu. You create an an [Alfresco SDK All-in-One project](../concepts/alfresco-sdk-archetypes-repo-amp.md) and add a [Share extension project](../concepts/alfresco-sdk-archetypes-share-amp.md) called customize-share-header-menu. Your customization is implemented as a [Surf extension module](../concepts/dev-extensions-share-surf-extension-modules.md).

1.  Create a new [All-in-One SDK project](alfresco-sdk-tutorials-all-in-one-archetype.md).

2.  In the top-level folder of your All-In-One \(AIO\) project, create a new Share AMP module as part of your AIO project. The instructions for this step are [here](alfresco-sdk-advanced-add-custom-amps-aio.md). Just create the Share AMP using the artifact id customize-share-header-menu and the same group id as your parent AIO project. You do not need to create the Repository AMP.

3.  In the customize-share-header-menu/src/main/amp/config/alfresco/web-extension/site-webscripts folder create a new folder called tutorials

    **Note:** tutorials is the path to the web script in this case, you can use a different path if required.

4.  In your IDE, navigate to the new tutorials folder and create a new webscript file called share-header.get.js\] with the following contents:
...
5.  In your IDE navigate to the customize-share-header-menu/src/main/amp/config/alfresco/web-extension/site-data/extensions folder, and create a new extension file called custom-header-extension.xml that contains the following extension definition:
...
6.  Run the [run.sh](../concepts/alfresco-sdk-cmd-reference-aio.md) command to add your new Surf extension module.
...
10. Now log back in to Alfresco Share and click on the **Admin Tools** menu item - you can see it is now a drop-down menu list.
