...
1.  Download the Web Quick Start zip bundle file:
    ...
    alfresco-wcmqs-5.1.5.zip

2.  Unzip the file into a temporary location. The artifacts supplied with Web Quick Start are:

    -   alfresco-wcmqs-5.1.5.amp \(AMP file for Alfresco\)
    -   alfresco-wcmqs-share-5.1.5.amp \(AMP file for Share\)
    -   awe.war \(Web Editor\)
...
4.  Copy the AMP files into the relevant amps directories for Alfresco and Share:
    ...
    1.  Copy the alfresco-wcmqs-5.1.5.amp file to the amps directory.

    2.  Copy the alfresco-wcmqs-share-5.1.5.amp file to the amps-share directory.
