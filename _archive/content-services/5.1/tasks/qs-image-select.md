...
5.  Locate and add the image as follows:
    ...
    **Note:** There are no templates that make use of the secondary image. However, users creating templates for their own websites might choose to use this feature.
