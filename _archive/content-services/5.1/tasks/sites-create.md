...
You can create a site from anywhere in Alfresco, and are automatically made the manager of the site you create.
...
4.  Select the site visibility:
    ...
    **Note:** The visibility setting you select is displayed next to the site name when a user is in the site. See [Alfresco sites](../concepts/sites-intro.md) for more information on site visibility settings.
