...
3.  Click **Select** beneath the **Web Assets** label to edit the associated content.
    ...
    On the Select page, the right column displays the assets already selected. The left column displays the repository structure, which you navigate to locate assets.
