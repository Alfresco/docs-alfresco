...
3.  You will now need to restart your SDK maven project using [run.sh](../concepts/alfresco-sdk-cmd-reference-aio.md).

4.  Check that Alfresco has restarted without errors \(either through checking the logs or logging into Share\).
