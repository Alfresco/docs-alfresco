...
1.  In the document library explorer panel choose where you want to add a folder.
    ...
    You'll create a new folder in the folder highlighted in the panel. If you don't select a folder in the panel then the new folder will be created at the current location shown in the file list.
