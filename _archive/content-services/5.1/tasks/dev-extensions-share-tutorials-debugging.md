...
11. On the **Debug Menu** item select **Update Logging Preferences**.
    ...
    **Attention:** Filter information is persisted to a user's preferences by default. This means that if you are debugging using different user accounts you will need to update the preferences for each user that you log in as.
