...
 Follow the steps to migrate from Alfresco Enterprise 4.x with Solr 1.4 search service to Alfresco One 5.1.5 with Solr 4 search service.

1.  Upgrade to Alfresco One 5.1.5  and continue to use the Solr 1.4 search service as before.

    For information on migrating the Solr 1.4 indexes with Alfresco One 4.x to Solr 1.4 with Alfresco One 5.1.5, see [Upgrading Solr 1.4 search service](upgrade-solr1.md).
