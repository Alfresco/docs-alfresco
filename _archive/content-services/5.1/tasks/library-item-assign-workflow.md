...
2.  Select a workflow from the **Workflow** list.
    ...
    -   **New Cloud Task or Review**

        Assign a new task or review to yourself or another user. This option is only available if your Alfresco administrator has enabled the Alfresco cloud sync and hybrid workflow options.
