...
|
|Sample Code|-   [Custom permission \(role\) implementation \(Repo AMP\)](https://github.com/Alfresco/alfresco-sdk-samples/tree/alfresco-51/all-in-one/add-permission-repo)
-   [Custom DocLib Action using custom permission \(role\) \(Share AMP\)](https://github.com/Alfresco/alfresco-sdk-samples/tree/alfresco-51/all-in-one/add-permission-share)
