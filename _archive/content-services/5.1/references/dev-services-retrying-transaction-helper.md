...
|Description|A description and application of the RetryingTransactionHelper can be found [here](dev-extension-points-public-java-api.md).|
...
|Java example|See [here](dev-extension-points-public-java-api.md).|
|More Information|See [here](dev-extension-points-public-java-api.md).|
|Tutorials|None|
