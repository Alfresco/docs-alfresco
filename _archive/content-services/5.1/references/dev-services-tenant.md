...
|Java example|An example of using the TenantService can be found on [GitHub](https://github.com/Alfresco/community-edition/blob/master/projects/repository/source/java/org/alfresco/repo/activities/script/Activity.java).|
