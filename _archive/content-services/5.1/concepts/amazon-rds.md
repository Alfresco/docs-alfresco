...
It is a web service running in the cloud and provides relational database for use in Alfresco. Amazon RDS supports and gives you online access to the capabilities of a MySQL, Oracle, Microsoft SQL Server, PostgreSQL, or Amazon Aurora relational database management system.

As a good practice, when using Amazon EC2 environment you may want to use S3 bucket for content store. For more information, see [Alfresco S3 Connector](http://docs.alfresco.com/s3connector/concepts/s3-contentstore-overview.html).
...
Use this information to configure an Aurora database on Amazon RDS for use with Alfresco. Amazon Aurora is a MySQL-compatible relational database management system.
...
Use this information to configure an Oracle database on Amazon RDS for use with Alfresco.
