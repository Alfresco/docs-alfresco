...
**Important:** Filtered search uses the Solr 4 search subsystem and is enabled by default from Alfresco One 5.0 onwards. For more information on migrating from your existing search subsystem to Solr 4, see the [Solr 4 migration documentation](search-migration.md).
