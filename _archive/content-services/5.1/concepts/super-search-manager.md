...
All existing filters \(including default filters\) are shown along with their details, in the order that they are shown on the search results screen. You can change the order by using the ![](../images/arrows.png) buttons to move filters up or down the order.

Click **Create New Filter** to [create new search filters](../tasks/create-filter.md).
...
**Parent topic:**[Alfresco power users](../concepts/alfresco-superusers.md)
