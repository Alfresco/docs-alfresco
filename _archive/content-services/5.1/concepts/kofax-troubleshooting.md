...
If you see an error message “Error opening release script “Alfresco Kofax Release Script" when adding the script to a document class, it is an indication that you might not have copied the binaries to your Kofax Capture bin directory.
