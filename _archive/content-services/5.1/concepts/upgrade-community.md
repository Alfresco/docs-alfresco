...
You can then follow the upgrade path to Alfresco One to upgrade to the most current release. See [Alfresco upgrade paths](upgrade-path.md) for more information.
