...
Any user, who authenticates by any mechanism, must have an associated person node in Alfresco. Person nodes can be:
...
Changes to Person node userNames will cause updates to other related data in Alfresco, such as ACL assignment.
