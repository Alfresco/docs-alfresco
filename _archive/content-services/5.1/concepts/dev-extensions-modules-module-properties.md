...
The module.properties file should be located in the directory extension\_root/alfresco/module/module\_name. Where extension\_root is the root directory of the extension, and module\_name is the name of the module.
