...
|solrconfig.xml|alfresco\\solr4\\workspace-SpacesStore\\conf or alfresco\\solr4\\archive-SpacesStore\\conf|This file specifies the parameters for configuring Solr. Also, the Solr search components are added to this file. The properties of this file are managed by an Alfresco expert Administrator user.|
|solrcore.properties|alfresco\\solr4\\workspace-SpacesStore\\conf or alfresco\\solr4\\archive-SpacesStore\\conf|This is the property configuration file for a core. Solr supports system property substitution, so properties that need substitution can be put in to this file. There is one solrcore.properties file in each core's configuration directory. For details, see the [Solr core configuration properties](solrcore4-properties-file.md) topic. The properties of this file are managed by an Alfresco Administrator user.|
