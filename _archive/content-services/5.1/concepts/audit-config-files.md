...
Or they can be declared in Spring configuration and referenced in the audit configuration \(see the [audit-services-context.xml](http://dev.alfresco.com/resource/AlfrescoOne/5.1/configuration/alfresco/audit-services-context.xml) file\), for example:
