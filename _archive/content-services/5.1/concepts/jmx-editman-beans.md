...
This MBean provides information about the CIFS and FTP servers configured in Alfresco.
...
This MBean provides information about the Google Docs configuration in Alfresco.
...
This MBean allows management and monitoring of the CIFS and FTP servers configured in Alfresco. See the Alfresco Admin Console Virtual File Systems - File Servers for information about these editable attributes: http://<hostname\>:<portnumber\>/alfresco/service/enterprise/admin/admin-fileservers.
