...
The Transformation Client configuration parameters are exposed as JMX MBeans, which means that you can view and set the parameters using a JMX console. 

Refer to the Alfresco documentation for instructions on how to connect a JMX console to your Alfresco server.
