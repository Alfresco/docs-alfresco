...
The content of the configuration may be any valid XML, such as the following:
...
Within a Controller Script, access to the configuration is via E4X which is essentially "ECMAScript For XML". Tutorials can be found at [WSO2](http://wso2.org/library/1050) and [PHPForms](http://phpforms.net/tutorial/tutorial.html).
