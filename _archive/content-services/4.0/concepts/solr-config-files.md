...
|solr-tomcat-context.xml|alfresco\\alf\_data\\solr|This file specifies the Solr web application context template to use when installing Solr in separate tomcat server.|
