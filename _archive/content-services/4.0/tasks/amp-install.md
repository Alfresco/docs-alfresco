...
The MMT is included in the Alfresco installers, and it is also available as a separate JAR file from the Alfresco WAR file bundle \(alfresco-enterprise-4.0.2.zip\).
