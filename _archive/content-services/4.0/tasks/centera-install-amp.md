...
2.  Download the alfresco40-41\_centera-connector-1.0.0-9.amp file.

3.  Use the Module Management Tool \(MMT\) to install the AMP.

    For example:

    `java -jar <installLocation>\bin\alfresco-mmt.jar install <installLocation>\amps\alfresco40-41\_centera-connector-1.0.0-9.amp <installLocation>\tomcat\webapps\alfresco.war`
