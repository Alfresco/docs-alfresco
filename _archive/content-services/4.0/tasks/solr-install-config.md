...
The distribution archive file is called alfresco-enterprise-solr-4.0.2.zip.
...
1.  Extract the alfresco-enterprise-solr-4.0.2.zip file to a location. For example, <SOLR-ARCHIVE\>.

2.  Copy the solr-tomcat-context.xml file to apache-tomcat-6.0.26\\conf\\Catalina\\localhost\\solr.xml.
...
12. To complete the installation, it is necessary to secure the two-way communication between Alfresco and Solr by generating your own keys. See the [Generating Secure Keys for Solr Communication](generate-keys-solr.md) section.
