...
-   **Synced Content**
    ...
    Displays the files that have been synchronized with an Alfresco Cloud site

-   **Synced Content**

    Displays the files that have been synchronized with an Alfresco One on-premise site

-   **Synced with Errors**

    Displays the files that have been synchronized with an Alfresco Cloud site, but have errors in the synchronization
