...
The beans that enforce security to the repository services based on the currently authenticated user are defined in the [public-services-security-context.xml](http://dev.alfresco.com/resource/AlfrescoOne/5.0/configuration/alfresco/public-services-security-context.xml) file.
