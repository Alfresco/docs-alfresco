...
2.  Enter your Alfresco user name and password.
    ...
    Your user name and password must be for an account with administrator permissions. The default installation user name is admin.
    ...
    A useful starting point in the Admin Console is the [System Summary](../concepts/adminconsole-systemsummary.md) page, which gives an overview of the which settings are enabled or disabled.
