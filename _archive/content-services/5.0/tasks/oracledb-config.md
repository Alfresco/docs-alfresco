...
**Note:** The Oracle Thin driver is recommended. Check the [supported platform](../concepts/supported-stacks.md) page for the proper driver and connection URL to use.
