...
You can also [create Google Docs content](library-create-content-googledocs.md) and [create content from templates](library-create-template.md).

You can also [create Google Docs content](library-create-content-googledocs.md).
...
The file is saved to Alfresco and displayed in the file preview screen.
