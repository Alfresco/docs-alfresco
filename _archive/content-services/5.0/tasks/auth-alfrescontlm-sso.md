...
2.  Edit the file, and then uncomment the following section:
    ...
    From Alfresco One 5.0.5 onwards, the RSS feed URLs no longer use the `alfresco` endpoint. To make the RSS feed work, add one of the following to the above code.
