...
2.  Set the following properties:
    ...
    |`solr.host`|The host name where the Solr 4 instance is located.|
    |`solr.port`|The port number on which the Solr 4 instance is running.|
    |`solr.port.ssl`|The port number on which the Solr 4 SSL support is running.|

    For example, some example properties for activating Solr 4 are:
