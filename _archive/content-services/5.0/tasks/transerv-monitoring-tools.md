...
# Integrating the Document Transformation Server with monitoring tools
...
The tool calls the Document Transformation Server URL with a set of parameters, and then monitors the response.
