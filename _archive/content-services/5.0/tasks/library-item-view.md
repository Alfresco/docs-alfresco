...
-   **Sync** - Displays information about content that has been synchronized with your Alfresco One account.
...
-   **Tasks** - Displays tasks that this file is included in. The profile picture of the user who started the task and the task type are shown. Click ![Tasks icon](../images/ico-workflow.png) to start a new task for this file, and click a task description to view the task.
...
This video shows you how to view an item in Alfresco.
