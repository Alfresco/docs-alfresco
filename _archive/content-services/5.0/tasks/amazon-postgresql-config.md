...
This section describes how to configure a PostgreSQL database on Amazon RDS for use with Alfresco.
...
5.  Install the PostgreSQL database connector. The database connector allows PostgreSQL database to talk to the Alfresco server.
    ...
    1.  Download postgresql-9.3-1102.jdbc4.jar from the PostgreSQL download site: [http://www.postgresql.org/download/](http://jdbc.postgresql.org/download.html).
