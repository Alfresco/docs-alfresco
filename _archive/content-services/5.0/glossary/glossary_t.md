...
-   **TinyMCE**
    ...
    TinyMCE is a platform independent web based Javascript HTML WYSIWYG editor control released as Open Source under LGPL \(GNU Lesser General Public License\). Source: [https://en.wikipedia.org/wiki/TinyMCE](https://en.wikipedia.org/wiki/TinyMCE)
