...
**Important:** This section of the documentation documents objects that are available to scripts running in the Repository context. They are not available to scripts running in the Share context.
