...
|`requestbody`|Object|A ScriptContent representing the content of the request body.
 ...
 As with formdata, the content can be converted to a string \(if appropriate\) or written to an output stream such as a content object held in the Alfresco Repository.
