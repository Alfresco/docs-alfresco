...
|
|Sample Code|-   [Sample code demonstrating access to Alfresco Public Java API](https://github.com/Alfresco/alfresco-sdk-samples/tree/alfresco-50/all-in-one/public-api-access-repo)
