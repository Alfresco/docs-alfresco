...
There is also the availability of the "hybrid" view of the page. By changing the URL to: http://<server\>:<port\>/share/page/hdp/ws/my-new-page \(note the additional "h"\) you will get the page content rendered between the standard Alfresco One header and footer.
