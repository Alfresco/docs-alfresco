...
|
|[Deployment - SDK Project](../tasks/alfresco-sdk-tutorials-share-amp-archetype.md)|-   share-amp/src/main/amp/config/alfresco/web-extension/site-data/extensions/ - Extension modules with Dojo package definitions \(i.e. the JavaScript packages where the Widgets live\)
...
-   [Creating custom Aikau Widgets](https://community.alfresco.com/community/ecm/blog/2013/02/26/creating-custom-share-widgets)
