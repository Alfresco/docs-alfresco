...
-   a secondary menu opens under the core name with the administration options available for that particular core. The core-specific options are:
    ...
    |Options|Description|
    |-------|-----------|
    |Analysis|Allows data analysis according to the field, field typem and dynamic rule configurations found in schema.xml.|
...
**Parent topic:**[Connecting to the SSL-protected Solr 4 web application](../tasks/ssl-protect-solrwebapp.md)
