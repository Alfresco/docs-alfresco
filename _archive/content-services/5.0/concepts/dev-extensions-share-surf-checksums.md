...
One of the problems that has affected upgrades of Alfresco in the past is that the end-user's browser can end up using cached copies of JavaScript and CSS files that have been updated during the upgrade. Alfresco Surf now has introduced a new service called the “DependencyHandler” which has been created to solve this specific problem.
