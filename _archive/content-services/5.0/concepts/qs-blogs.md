...
In addition to capturing the Contact page visitor feedback in a data list, the submission of this website form triggers a simple workflow in the Share site, enabling a designated user \(the system administrator by default\) to track and address the communication.
