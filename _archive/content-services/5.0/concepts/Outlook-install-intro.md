...
Version 1 of Alfresco Outlook Integration is supported with Alfresco One 5.0.2 and earlier only, and has a reduced set of features. See [Alfresco Outlook Integration 1.1](http://docs.alfresco.com/outlook1.1/concepts/Outlook-overview_v1.html) for previous releases of Outlook Integration.
