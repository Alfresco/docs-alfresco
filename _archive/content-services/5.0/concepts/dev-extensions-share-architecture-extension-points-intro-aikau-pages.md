...
Now restart Alfresco and then access the page with the `http://localhost:8080/share/page/hdp/ws/helloworld` URL. You should see the following page in Share:

![](../images/dev-extensions-share-surf-page-helloworld-aikau.png)

The page we choose as a basis \(i.e. the Hybrid Dynamic Surf Page - `hdp`\) provides both the header and the footer for the Share web application. If you want to see the page stand-alone you can use the `dp` page as a basis.
