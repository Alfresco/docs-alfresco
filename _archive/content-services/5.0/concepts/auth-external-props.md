...
Th external subsystem supports the following properties.
...
-   **external.authentication.proxyUserName**
    ...
    **Note:** The default setting for `external.authentication.proxyUserName` is `alfresco-system`, but this should only be specified if you are using SSL. See [External authentication and SSO](auth-basics.md) for more information.
