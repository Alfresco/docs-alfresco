...
If you have installed the Oracle Java SE Development Kit \(JDK\), and have enabled JMX in our configuration files, there are some support operations that can be performed on-demand at runtime without needing to restart the server.
