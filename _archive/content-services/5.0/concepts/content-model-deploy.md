...
You can deploy a content model into the content repository using either the bootstrap method, which requires a reboot; or the dynamic method, which does not require a reboot.
