...
|
|`syncui.enableAnalytics`|`true`|Controls whether Alfresco Content Services collects anonymized data.|
|`syncui.language`| |Add this property to specify the language for the Desktop Sync UI \(requires app restart\). See [Localization](ds-config-mac.md#l10n) for supported values.|
