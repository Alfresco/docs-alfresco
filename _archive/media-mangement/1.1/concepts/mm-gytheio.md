...
For more information on advanced ActiveMQ settings, see [Configuring advanced settings in ActiveMQ](http://docs.alfresco.com/5.2/concepts/activemq-config.html).
