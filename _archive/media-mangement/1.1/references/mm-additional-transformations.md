...
Audio and video files are transformable using FFmpeg. Image files are transformable using ImageMagick. The formats listed are in addition to the standard formats as specified in [Transformation options](http://docs.alfresco.com/5.2/references/valid-transformations.html).
