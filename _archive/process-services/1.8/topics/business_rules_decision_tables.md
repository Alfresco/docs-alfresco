...
![images/decision-process.png](../images/decision-process.png)
...
The process' start form is shown below and defines 4 fields: *obligationsCompleted* \(*boolean*\), *additionalAchievements* \(*string*\), *completedDate* \(*date*\) and *dueDate* \(*date*\). See the [Form editor](form_editor.md) section for more information on how to create forms.

![images/decision-process-start-form.png](../images/decision-process-start-form.png)
...
![images/decision-table-editor.png](../images/decision-table-editor.png)
...
![images/decision-table-editor-rules.png](../images/decision-table-editor-rules.png)
...
![images/decision-table-input-expression.png](../images/decision-table-input-expression.png)
...
![images/decision-table-output-expression.png](../images/decision-table-output-expression.png)
...
![images/decision-table-expression-date.png](../images/decision-table-expression-date.png)
...
![images/decision-process-gateway-condition.png](../images/decision-process-gateway-condition.png)
...
![images/decision-process-start.png](../images/decision-process-start.png)
...
![images/decision-process-details.png](../images/decision-process-details.png)
...
![images/decision-process-table-audit.png](../images/decision-process-table-audit.png)
...
![images/decision-process-table-audit-input.png](../images/decision-process-table-audit-input.png)
...
![images/decision-process-table-audit-output.png](../images/decision-process-table-audit-output.png)
