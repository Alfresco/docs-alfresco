...
The installed Alfresco Process Services runs in its own [Apache Tomcat](http://tomcat.apache.org/) container, and uses a built-in [h2 database](http://www.h2database.com/). This database is not suitable for production use.
