...
See [Administering Alfresco Process Services](adminGuide.md) for details on how to configure events to be sent to ElasticSearch\), but must be implemented as a custom Spring bean.
