...
All process definitions that you deploy to Apps in Alfresco Process Services are available to you in Alfresco Share. This section assumes that you have deployed the first process workflow using the app-creating-process tutorial described in [Administering Alfresco Process Services](adminGuide.md). If not, follow the tutorial to deploy the workflow.
