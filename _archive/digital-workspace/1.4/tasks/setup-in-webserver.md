...
**Note:** When deploying Alfresco Digital Workspace to a different web server, it is recommended you setup Cross-Origin Resource Sharing \(CORS\). For more information, see [CORS configuration](https://docs.alfresco.com/6.2/concepts/enabling-cors.html) and [Cross-Origin Resource Sharing \(CORS\)](https://enable-cors.org/).
