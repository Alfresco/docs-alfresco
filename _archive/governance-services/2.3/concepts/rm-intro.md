...
If you're new to Alfresco then take a look at [Using Alfresco](http://docs.alfresco.com/5.0/topics/sh-uh-welcome.html) to help you get started.
...
-   **[Records based on existing files \(in-place records\)](../concepts/rm-in-place.md)**  
