...
# Upgrading in-place records from pre-2.3.0.8 versions
...
**Note:** In-place records created on Records Management 2.3.0.8 and later are shown without running the webscript.
...
4.  Results and/or errors are reported as a JSON-formatted string, or a CSV file if you use the *export* parameter. Processed records are shown in the alfresco.log as below:
    ...
    **Note:** This upgrade may cause the modifier and modified dates of records to show the user and date when the upgrade was run.
