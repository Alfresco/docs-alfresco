...
The recommended path for upgrading Records Management is from Version 4.1.x to Version 5.0.1.

Once you are running version 4.1.x, use the standard upgrade process for Alfresco to upgrade to 5.0.1, and then when the Alfresco installation is upgraded, you can apply the new AMP files for Records Management 2.3.
...
2.  Download Alfresco Version 5.0.1 and the Records Management AMP zip from the [Support Portal](http://support.alfresco.com).

3.  Download Alfresco Version 5.0.1 and the Records Management AMP zip.

4.  Upgrade to Alfresco 5.0.1.

    For more information about upgrading Alfresco One, see [Upgrading Alfresco](http://docs.alfresco.com/5.0/concepts/ch-upgrade.html).
...
5.  Apply the Records Management 2.3 AMPs to the upgraded Alfresco installation.
...
If you upgrade from a pre-2.3.0.8 version of Records Management, then an additional webscript needs to be run so that in-place records created in pre-2.3.0.8 sites are shown in the search results of users without Records Management permissions.
