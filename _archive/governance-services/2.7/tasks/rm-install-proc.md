...
1.  Download and apply the Records Management AMP files to your existing Alfresco Content Services installation. You can download the installation files from the [Support Portal](http://support.alfresco.com/).
