...
5.  Click **Create**.
    ...
    -   Click ![Delete group](../images/ico-trashcan.png) to delete the group. You can't delete a group or its marks if it contains marks that are assigned to content.
