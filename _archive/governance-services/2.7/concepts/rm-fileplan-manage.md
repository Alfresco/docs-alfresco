...
**Note:** The standard Alfresco **Copy to**, **Move to** and renaming options are available for record categories, record folders, and records. See [Keeping your library organized](http://docs.alfresco.com/5.2/concepts/library-organize.html) for further details.

**Note:** The standard Alfresco **Copy to**, **Move to** and renaming options are available for record categories, record folders, and records. See [Keeping your library organized](http://docs.alfresco.com/community/concepts/library-organize.html) for further details.
