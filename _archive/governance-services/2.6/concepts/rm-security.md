...
# Security controls and classification
...
There is one predefined **Classification** security group, and you can add as many additional security groups as you need.

Files, records, folders, and categories can be classified using their **Classify** option to apply a security classification and security marks.

You can also set up classification guides so that users can auto-classify content.
