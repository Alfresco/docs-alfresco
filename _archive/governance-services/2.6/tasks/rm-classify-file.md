...
8.  **To manually add classifications and security marks:**
9.  Select a classification from:
...
10. Enter a classification agency, for example, government or other body \(optional\).

11. Select one or more classification reasons from the list of available reasons.

12. You can optionally set a **Downgrade Schedule** or a **Declassification Schedule**.
...
13. Click security marks to apply them to the item, and again to remove them.
