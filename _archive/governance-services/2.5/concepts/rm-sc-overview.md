...
In both cases you can apply security marks to both records in a Records Management site, and files in a standard Alfresco site. These same marks are applied to users to set their security clearance levels.
...
When you create a new security group there are three clearance types available:
