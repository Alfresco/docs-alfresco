...
When security groups are created there are three different clearance types available, and each one controls how the user sees content, see [How security controls work](rm-sc-overview.md).
