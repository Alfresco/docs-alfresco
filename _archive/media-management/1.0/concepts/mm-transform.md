...
You can perform an ad hoc format transformation in a number of ways; for example, create a rule with a Transform and Copy Content action. See [Applying rules to folders](http://docs.alfresco.com/5.1/concepts/library-folder-rules.html) for more information about setting up rules.
