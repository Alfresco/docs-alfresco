...
-   Email Search Settings: custom simple and advanced search settings
...
You can configure search settings for Alfresco Outlook Integration using Share Admin Tools. These settings define global controls across your enterprise and are applied immediately.
