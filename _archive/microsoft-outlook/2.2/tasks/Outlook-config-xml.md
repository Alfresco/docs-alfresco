...
The AlfrescoClientSettings-2.2.0.xml file contains advanced configuration properties. Use this file to set up attributes and metadata settings.

1.  Locate and open AlfrescoClientSettings-2.2.0.xml in the C:\\Users\\<username\> directory, where <username\> is your Windows user name.
