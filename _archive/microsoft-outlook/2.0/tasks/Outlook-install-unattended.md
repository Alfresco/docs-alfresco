...
1.  Extract the contents of the alfresco-outlook-client-2.0.0-19.zip file using a standard unzip tool.

2.  Locate x64/AlfrescoOutlookClient\_x64\_2.0.0.msi or x86/AlfrescoOutlookClient\_x86\_2.0.0.msi, depending on whether you are running a 64-bit or 32-bit version of Windows.

3.  From a command line, navigate to the x64 or x86 directory, and run the msiexec command. For example:

    ```
    msiexec /i AlfrescoOutlookClient\_x86\_2.0.0.msi HOST=127.0.0.1:8080 AUTH=basic
    ```
