...
Ensure that you have applied the Alfresco Outlook Server AMP files. See [Installing Alfresco Outlook Integration](Outlook-amp_v1.md) for more information. You also need your client and server license files.
...
The licenses are installed successfully and you are ready to install the Alfresco Outlook Client in Microsoft Outlook.
