...
3.  Check the box to Enable custom metadata support.
...
6.  Edit the XML settings in the second Configuration XML content field or use your own settings. The default configuration template is preloaded.
