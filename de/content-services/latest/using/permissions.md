...
menutitle: Benutzerrollen und Berechtigungen
---
...
Site-Manager können eine [Site-Rolle für die Site-Benutzer ändern]({% link content-services/latest/using/sites/index.md %}#changing-a-site-role).
