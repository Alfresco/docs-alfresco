...
> **Important:** The SAP Connector module can be applied to several versions of Content Services. See [Prerequisites]({% link sap/5.2/install/index.md %}#prerequisites) and [Supported Platforms]({% link sap/5.2/support/index.md %}) for more.
