...
See the [Opening associated Business Object in SAP]({% link sap/5.2/config/advanced.md %}#openassocbusinessobjinsap) feature to learn how to enable and how to customize it.
...
See [Configure repository properties]({% link sap/5.2/install/index.md %}#configrepo) and the [example configurations](#examplesapsysconfigs). The properties in the table below use [SAP system configuration with Archivelink only](#examplesapsysconfig1) as an example.
