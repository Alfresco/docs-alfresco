...
If there is a need to call other than the default SAP Object Types, see the [Advanced configuration](#OpenBusinessObjectSAPAdvancedConfig). Also, see [Reference for SAP Object Type Mapping]({% link sap/latest/admin/reference.md %}#refsapobjecttypemap).
