...
See the [Opening associated Business Object in SAP]({% link sap/latest/config/index.md %}#openassocbusinessobjinsap) feature to learn how to enable and how to customize it.
