...
7. To use wildcards (added in Outlook Integration 2.8.1), add the asterisk character in the folder path, for example:
    ...
    This rule allows you to assign the search configuration to every `myexample-1-site-standard-search` located under any `st:sites`, and with any number of folders between `st:sites` and `myexample-1-site-standard-search`.
