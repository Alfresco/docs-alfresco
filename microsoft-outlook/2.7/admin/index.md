...
* Configure the Alfresco SAML module - [Configure SAML SSO]({% link saml-module/latest/config/index.md %})
  ...
  * Enable SAML in Outlook clients using one of the following options: [using the client configuration XML]({% link microsoft-outlook/2.7/config/index.md %}#advanced-configuration) or [using the command line]({% link microsoft-outlook/2.7/install/index.md %}#installunattendedmode).
