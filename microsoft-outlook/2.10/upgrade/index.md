...
3. Uninstall the Outlook Integration AMP files, using MMT (Module Management Tool).
    ...
    See [Uninstall Outlook Integration]({% link microsoft-outlook/2.10/install/index.md %}#uninstall) for instructions on how to uninstall the AMP files.
...
4. Download, extract and install the new Outlook Integration files.
    ...
    You do not need to uninstall a previous version of Alfresco Outlook Client. You can install the new client and all settings are transferred to the new version. See [Install Outlook Integration]({% link microsoft-outlook/2.10/install/index.md %}) for instructions on how to do this.
...
7. Starting from Outlook Integration 2.10 and with the deprecation of Alfresco SAML Module, the authentication protocol has changed to OpenId Connect.
    ...
    See [Using SAML SSO with Outlook Integration]({% link microsoft-outlook/2.10/admin/index.md %}) for the client-side configuration details:
