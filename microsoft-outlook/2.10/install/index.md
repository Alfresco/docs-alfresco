...
There are a number of software requirements for installing Outlook Integration. See [Supported Platforms]({% link microsoft-outlook/2.10/support/index.md %}) for more information.
