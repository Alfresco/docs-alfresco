...
The Alfresco Collaboration Connector for Teams can be installed using Docker Compose or a distribution zip.
...
In order to use the Alfresco Collaboration Connector for Teams, you will need a Microsoft 365 Business, Enterprise or Government subscription plan.
...
A single-page application needs to be registered in your Microsoft Azure Active Directory to complete the installation and configuration of the Alfresco Collaboration Connector for Teams.
