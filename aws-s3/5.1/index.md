...
* Support for AWS Glacier storage type and introduction of [Cloud Storage Properties]({% link aws-s3/5.1/config/index.md %}#cloud-storage-properties) (v5.0).
* [Direct Access URLs]({% link aws-s3/5.1/config/direct-access.md %}) (v4.1)
* [S3 Content Store Subsystems]({% link aws-s3/5.1/config/index.md %}#content-store-subsystems) (v3.1)
...
>[some limitations]({% link aws-s3/5.1/config/index.md %}#onpremconfig). Other devices or services that advertise as 
