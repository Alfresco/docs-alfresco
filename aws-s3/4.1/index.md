...
This release of the S3 Connector is a compatibility release to support Alfresco Content Services 7.1, and adds the ability to accelerate the local download of content. See [Direct Access URLs]({% link aws-s3/4.1/config/direct-access.md %}) for more details.
...
* [S3 Content Store Subsystems]({% link aws-s3/4.1/config/index.md %}#content-store-subsystems) (v3.1)
