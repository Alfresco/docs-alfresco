...
A number of customers have requested that the [Alfresco Content Encryption](TODO_LINK:https://docs.alfresco.com/6.2/concepts/encrypted-overview.html) module should be able to be deployed in conjunction with AWS KMS encryption on the S3 Content Store. In this release, we have taken steps to make this possible and it should be supported in the next release of the S3 Connector.
...
The S3 Connector supports Amazon S3 Glacier. See [Alfresco Content Connector for AWS Glacier](TODO_LINK:https://docs.alfresco.com/glacier/concepts/glacier-welcome.html) for more information.
