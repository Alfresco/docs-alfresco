...
> **Important:** The SAP Cloud Connector module can be applied to several versions of Content Services. See [Prerequisites]({% link sap-cloud/1.0/install/index.md %}#prerequisites) and [Supported Platforms]({% link sap-cloud/1.0/support/index.md %}) for more.
