...
Amazon S3 Glacier is supported with Alfresco Content Services and Alfresco Governance Services. See [Glacier Connector FAQs]({% link aws-glacier/2.0/using/index.md %}) for more information.
...
> **Note:** For more information on Amazon S3 Glacier retrieval tiers, see [Retrieving Glacier Archives](https://docs.aws.amazon.com/amazonglacier/2.0/dev/downloading-an-archive-two-steps.html){:target="_blank"}.
