...
* SAML SSO [installed]({% link saml-sso/1.1/install/index.md %}) and [configured]({% link saml-sso/1.1/config/index.md %}).
...
1. [Configure the REST API]({% link saml-sso/1.1/config/alfresco.md %}#alfresco-rest-api).
