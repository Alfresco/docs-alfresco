...
See the [Security Controls]({% link content-services/7.2/admin/control-center.md %}#security-controls) section of the Content Services - Control Center documentation for more details.