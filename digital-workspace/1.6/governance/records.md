...
> **Note:** When records are deleted from a collaboration site they are not removed from the Records Management File Plan; only the view of the record from the collaboration site is deleted and the record continues to be managed in the File Flan.
