...
2. Create the following `.env` file.
    ...
    > **Note:** The Digital Workspace 4.0.x uses the Content Application version 4.0.0.
...
Below are the available tutorials on the most common and requested tasks about developing ADF based applications. To build, debug, test, or troubleshoot the Alfresco Digital Workspace and ADF-based applications see [Manage Digital Workspace]({% link digital-workspace/4.0/develop/manage.md %}).
