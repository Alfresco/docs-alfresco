...
![Sync Service metrics - Graphite]({% link sync-service/images/ds-monitor-graphite.png %})
...
You can create your own dashboard view with various charts and graphs in Grafana by following the steps in [Using Grafana]({% link sync-service/latest/admin/monitor/grafana.md %} )
