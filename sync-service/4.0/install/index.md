...
See [Supported platforms]({% link sync-service/4.0/support/index.md %}) for more.
...
There are several [options]({% link sync-service/4.0/install/options.md %}) for installing the Sync Service:
