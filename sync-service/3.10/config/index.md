...
* [Connect to Sync Service through JMX]({% link sync-service/3.10/config/jmx.md %})
* [Run Sync Service via a script]({% link sync-service/3.10/config/script.md %})
...
The following prerequisites are required - see the [Supported platforms]({% link sync-service/3.10/support/index.md %}) page for specific versions:
