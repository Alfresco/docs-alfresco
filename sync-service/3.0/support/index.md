...
The following are the supported platforms for Alfresco Sync Service 3.0:

| Version | Notes |
| ------- | ----- |
| Alfresco Content Services 6.0 | Optionally with Alfresco Governance Services 3.0 |
...
| | |
| **Databases** |
| PostgreSQL 9.4.4, PostgreSQL 10.1 | |
| MySQL 5.7.17 | |
| Oracle 12c, 19c | |
| Amazon Aurora MySQL | |
