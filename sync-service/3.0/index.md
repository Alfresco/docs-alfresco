...
> **Note:** The Sync Service module can be applied to Alfresco One, and previous versions of Alfresco Content Services. See [prerequisites]({% link sync-service/3.0/install/index.md %}) for more.
