...
1. Create a custom model from the **Model Manager** in Alfresco Share **Admin Tools**.
    ...
    Follow the steps in [Creating a new model](https://docs.alfresco.com/6.0/tasks/admintools-custom-model-create.html)(#LINK).
...
2. Click the model name to start creating an associated aspect.
    ...
    Follow the steps for [Creating new aspects](https://docs.alfresco.com/6.0/tasks/admintools-custom-type-create.html)(#LINK).
...
5. Create a folder rule that applies the aspect to newly created and updated content.
    ...
    Follow the steps in [Creating a rule](https://docs.alfresco.com/6.0/tasks/library-folder-rules-define-create.html)(#LINK).
    ...
    See [Applying rules to folders](https://docs.alfresco.com/6.0/concepts/library-folder-rules.html)(#LINK) for more details.
...
> **Note:** Apply the new aspect to all existing content in the folder, and subfolders. Adding an aspect manually to existing folders doesn't cascade the extra functionality down the hierarchy. See [Applying aspects](https://docs.alfresco.com/6.0/tasks/library-item-manage-aspects.html)(#LINK) for more details.
