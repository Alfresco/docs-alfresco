...
See [Supported platforms]({% link sync-service/3.11/support/index.md %}) for more.
...
There are several [options]({% link sync-service/3.11/install/options.md %}) for installing the Sync Service:
