...
Before you start the Sync Service, see the [Prerequisites]({% link sync-service/3.3/install/index.md %}) and `Readme.txt` file included in the `AlfrescoSyncServer-3.3.x.zip` for more information.
