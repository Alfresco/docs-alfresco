...
Before you start the Sync Service, see the [Prerequisites]({% link sync-service/3.6/install/index.md %}) and `Readme.txt` file included in the `AlfrescoSyncServer-3.6.x.zip` for more information.
