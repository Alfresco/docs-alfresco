...
Before you start the Sync Service, see the [Prerequisites]({% link sync-service/3.2/install/index.md %}) and `Readme.txt` file included in the `AlfrescoSyncServer-3.2.x.zip` for more information.
