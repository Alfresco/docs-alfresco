...
4. Override the SSL properties as shown.
    ...
    See [Install the Tomcat application server LINK LINK](https://docs.alfresco.com/6.1/tasks/configfiles-change-path.html) and [Solr configuration files]({% link search-services/latest/config/index.md %}#solr-configuration-files) for more.
