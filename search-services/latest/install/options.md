...
* Installed Alfresco Content Services 6.2 or above, see [Supported platforms]({% link search-services/latest/support/index.md %}). If you are installing the Community Edition, no need to worry about this task as it already has the files need for installation.
