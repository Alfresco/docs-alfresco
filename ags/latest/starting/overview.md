...
This guide is split into two sections, one for [Governance Services managers](../concepts/rm-gs-managers.md), 
and one for [Governance Services users](../concepts/rm-gs-users.md). 
