...
representing the core Alfresco Governance Services functionality, is applied to the Alfresco Repository WAR file, and the other, 
representing the Alfresco Governance Services UI component is applied to the Alfresco Share WAR file. 

Both of the AMP files need to be removed in order to uninstall Alfresco Governance Services. 
...
2. Find the core Alfresco Governance Services AMP file using the following command:
    ...
    Module 'alfresco-rm-enterprise-repo' installed in 'webapps/alfresco'
       ...
       -    Version:      3.3.1
       -    Install Date: Tue Jul 07 08:50:15 UTC 2020
...
3. Find the Share RM AMP file using the following command:
    ...
    -    Version:      3.3
    -    Install Date: Sun Dec 29 12:05:24 BST 2019
