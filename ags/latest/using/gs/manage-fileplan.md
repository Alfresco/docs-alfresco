...
2. Select one or more holds and click **OK**.
    ...
    A message displays confirming that the folder is on hold, and the folder now displays the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon.
...
When the record is on hold (identified by the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon), a limited set of actions is available.

Vital records display the ![Vital record]({% link ags/images/ico-rm-vitalrecord.png %}){:height="18px" width="18px"} icon.
...
3. Click **Link**.
    ...
    A link is created in the destination folder. All copies of the record display the ![Linked]({% link ags/images/ico-rm-linkedrecord.png %}){:height="18px" width="18px"} icon.
...
3. Click **Select Record** and then select a record to create a relationship with by clicking ![Add]({% link ags/images/ico-add.png %}){:height="18px" width="18px"}.
...
2. Select one or more holds and click **OK**.
    ...
    A message displays confirming that the record or record folder is on hold, and it displays the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon.
...
2. Select one or more holds and click **OK**.
    ...
    A message displays confirming the content is on hold, and the content now displays the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon.
...
In the Holds area you can see your holds. When you go into a hold you can see the items it contains. The items aren't removed from the File Plan. They retain their place in the File Plan or Collaboration site with limited actions available, and are identified as being on hold by the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon.

>**Note:** Only users with permissions to view a hold will see the ![Frozen]({% link ags/images/ico-rm-frozen.png %}){:height="18px" width="18px"} icon next to records in the File Plan that are on that hold. Users without permission to view the hold will see the record but have no indication that it is on a hold. This provides confidentially on record holds.
