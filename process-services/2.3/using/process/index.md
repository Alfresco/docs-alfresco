...
The following predefined variables can also be used depending on the `assignment` of the [user task]({% link process-services/2.3/using/process/bpmn.md%}#user-task):
