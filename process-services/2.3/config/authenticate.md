...
>**Note:** Please refer to the [supported platforms]({% link process-services/2.3/support/index.md %}) page to see which parts of Process Services are compatible with the Identity Service.
