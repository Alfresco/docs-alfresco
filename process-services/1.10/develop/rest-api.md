...
By default, CORS is not allowed to provide a high level of security. This can be alleviated by using web proxies which consolidate different domains and ports or by enabling CORS in Process Services configuration. For more information, see [Configuring CORS]({% link process-services/1.10/config/index.md %}#cors).
...
For more info about Identity Management, see [this]({% link process-services/1.10/using/process/index.md %}#identity-management) section.
