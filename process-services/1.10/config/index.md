...
* A [database connection]({% link process-services/1.10/config/database.md %}) using a JDBC connection or JNDI data source.
* An accurate [Hibernate dialect]({% link process-services/1.10/config/database.md %}#hibernate-settings).
