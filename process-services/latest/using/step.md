...
|Act as|Identity of the caller: Process Initiator or Specific User. Selecting **Specific User** lets you select a different user. When the Identity Service is configured for Alfresco Content Services and Alfresco Process Services, a stored token will be used for authentication to Alfresco Content Services.<br><br>|
