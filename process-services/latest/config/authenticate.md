...
|ldap.synchronization.activate.users|Possible values: <br><br>- `NONE`: No users will be activated during LDAP synchronization.<br>- `APP`: Only users that have been deactivated through APS UI will be activated.<br>- `LDAP`: Only users that have been deactivated in a previous LDAP synchronization will be activated.<br> - `ANY`: Activates all users regardless the way they were deactivated before.<br><br>Default value: `NONE` |
