...
* [Using the Share Connector]({% link process-services/1.11/using/share-connector.md %})
...
>**Note:** Many of the following properties to configure SSO with Content Services use [Identity Service properties]({% link process-services/1.11/config/authenticate.md %}#identity-service) as their default values.
