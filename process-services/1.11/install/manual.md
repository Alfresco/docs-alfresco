...
To install Process Workspace from a WAR file, visit [Hyland Community](https://community.hyland.com/){:target="_blank"} and download the 1.11 version of `process-workspace.war`.
