...
You can use the Process Services setup wizard to upgrade to the 1.11 version. The process is similar to [installing for the first time]({% link process-services/1.11/install/manual.md %}#install-using-setup-wizards).
...
>**Tip**: You can also upload a [license]({% link process-services/1.11/install/manual.md %}#license) from the user interface.
...
Review the [Supported Stacks]({% link process-services/1.11/support/index.md %}) list to see what’s supported.
