...
>**Note:** Please refer to the [supported platforms]({% link process-services/2.4/support/index.md %}) page to see which parts of Process Services are compatible with the Identity Service.
