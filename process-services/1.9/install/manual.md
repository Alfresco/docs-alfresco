...
Ensure you have read the [supported platforms]({% link process-services/1.9/support/index.md %}) to confirm that your web container and database combination is supported before commencing with installation.
...
1. Download the latest [supported version]({% link process-services/1.9/support/index.md %}) of Process Workspace from [artifacts.alfresco.com](https://artifacts.alfresco.com/nexus/){:target="_blank"}.
