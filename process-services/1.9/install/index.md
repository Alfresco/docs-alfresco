...
* [Install with setup Wizards]({% link process-services/1.9/install/manual.md %}#install-using-setup-wizards)
* [Install manually]({% link process-services/1.9/install/manual.md %}#install-manually)
* [Install using containers]({% link process-services/1.9/install/container.md %})
