...
[Process Workspace]({% link process-services/2.2/using/workspace.md %}) is and alternative end-user interface for starting and managing tasks and processes that are currently running.
