...
You can use the Process Services setup wizard to upgrade to the 2.2 version. The process is similar to [installing for the first time]({% link process-services/2.2/install/manual.md %}#install-using-setup-wizards).

Follow these steps to upgrade:

1. Double-click the Process Services setup wizard.
2. Follow the instructions to install the 2.2 version of Process Services.
...
>**Tip**: You can also upload a [license]({% link process-services/2.2/install/manual.md %}#license) from the user interface.
...
Review the [Supported Stacks]({% link process-services/2.2/support/index.md %}) list to see what’s supported.
