...
>**Note:** Many of the following properties to configure SSO with Content Services use [Identity Service properties]({% link process-services/2.2/config/authenticate.md %}#identity-service) as their default values.
